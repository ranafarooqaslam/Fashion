...
namespace CORNBusinessLayer.Classes
{
    ...
    public class SaleForceController
    {
        ...
        public DataTable GetCustomerByDate(int p_Distributor_Id, DateTime p_FromDate, DateTime p_ToDate, int P_type)
        {
            IDbConnection mConnection = null;
            try
            {
                mConnection = ProviderFactory.GetConnection(Configuration.ConnectionString, EnumProviders.SQLClient);
                mConnection.Open();
                uspGetCustomerByDate mArea = new uspGetCustomerByDate();
                mArea.Connection = mConnection;
                mArea.DISTRIBUTOR_ID = p_Distributor_Id;
                mArea.FROM_DATE = p_FromDate;
                mArea.TO_DATE = p_ToDate;
                mArea.TYPE_ID = P_type;
                DataTable dt = mArea.ExecuteTable();
                return dt;
