	...
	public class ChequeEntryController
    {
        ...
        public string InsertChequeEntry(int p_distributorId, int p_Principal_id, long p_Customer_Id, string p_Cheque_No, string p_Bank_Name, DateTime p_Cheque_Date, DateTime p_Received_Date, DateTime p_Deposit_Date, DateTime p_Realization_Date, decimal p_Cheque_Amount, int p_Status_Id, DateTime p_Time_Stamp, int p_User_Id, string p_SlipNo, string p_Remarks, long p_AccountHead, int pType)
        {
            ...
            try
            {
                ...
                mspInsertCheque_Entry.chequeType = pType;
        ...
        public void  RollbackChequeEntry(int p_PRINCIPAL_ID, int p_DISTRIBUTOR_ID, string p_CHEQUE_NO, long p_CHEQUE_PROCESS_ID,long p_VoucherNo)
        {
