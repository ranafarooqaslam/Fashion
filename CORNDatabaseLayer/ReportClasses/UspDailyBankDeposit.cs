...
{
	public class UspDailyBankDeposit
	{
        #region Private Members
        private string sp_Name = " UspDailyBankDeposit";
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "UspDailyBankDeposit";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "UspDailyBankDeposit";
