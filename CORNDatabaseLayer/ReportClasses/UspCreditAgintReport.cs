...
{
    public class UspCreditAgintReport
    {
        #region Private Members
        private string sp_Name = " UspCreditAgintReport";
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "UspCreditAgintReport";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "UspCreditAgintReport";
