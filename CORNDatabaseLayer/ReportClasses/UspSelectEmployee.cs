...
{
	public class UspSelectEmployee
	{
		#region Private Members
		private string sp_Name = " UspSelectEmployee" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "UspSelectEmployee";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "UspSelectEmployee";
