...
{
    public class UspOrderBookerSheet
    {
        #region Private Members
        private string sp_Name = " UspOrderBookerSheet";
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "UspOrderBookerSheet";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "UspOrderBookerSheet";
