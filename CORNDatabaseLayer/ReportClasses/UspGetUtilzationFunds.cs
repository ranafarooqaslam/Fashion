...
{
	public class UspGetUtilzationFunds
	{
		#region Private Members
		private string sp_Name = " UspGetUtilzationFunds" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "UspGetUtilzationFunds";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "UspGetUtilzationFunds";
