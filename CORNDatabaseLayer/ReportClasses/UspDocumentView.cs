...
{
	public class UspDocumentView
	{
		#region Private Members
		private string sp_Name = " UspDocumentView" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "UspDocumentView";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "UspDocumentView";
