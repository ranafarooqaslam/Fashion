...
{
	public class UspRptSelectCUSTOMER
	{
		#region Private Members
		private string sp_Name = " UspRptSelectCUSTOMER" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "UspRptSelectCUSTOMER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "UspRptSelectCUSTOMER";
