...
{
	public class uspGetSalesPurchaseRegister
	{
		#region Private Members
		private string sp_Name = " uspGetSalesPurchaseRegister" ;
		...
		#region Constructor
		public uspGetSalesPurchaseRegister()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspGetSalesPurchaseRegister";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspGetSalesPurchaseRegister";
