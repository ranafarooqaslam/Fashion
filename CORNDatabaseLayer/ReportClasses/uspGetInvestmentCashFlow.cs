...
{
	public class uspGetInvestmentCashFlow
	{
		#region Private Members
		private string sp_Name = " uspGetInvestmentCashFlow" ;
		...
		#region Constructor
		public uspGetInvestmentCashFlow()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspGetInvestmentCashFlow";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspGetInvestmentCashFlow";
