...
namespace CORNDatabaseLayer.Classes
{
	public class GetPurchasedocument
	{
        ...
        public int DISTRIBUTOR_TO_ID { get; set; }
		...
		{
            m_PURCHASE_ID = Constants.LongNullValue;
		...
		public string ExecuteScalar()
		{
			...
			public void FirstReader(IDataReader dr)
			{
				if(dr.Read())
				{
					...
					m_PURCHASE_ID= Convert.ToInt64(dr["PURCHASE_ID"]);
		    ...
		    public void GetParameterCollection(ref IDbCommand cmd)
		{
            ...
            parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
			parameter.ParameterName = "@PURCHASE_ID" ; 
			parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.BigInt);
			if(m_PURCHASE_ID==Constants.LongNullValue)
			{
				parameter.Value = DBNull.Value;
			}
			else
			{
				parameter.Value = m_PURCHASE_ID;
			}
			pparams.Add(parameter);
            ...
            parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
            parameter.ParameterName = "@DISTRIBUTOR_TO_ID";
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.Int);
            if (DISTRIBUTOR_TO_ID == Constants.IntNullValue)
            {
                parameter.Value = DBNull.Value;
            }
            else
            {
                parameter.Value = DISTRIBUTOR_TO_ID;
            }
            pparams.Add(parameter);
        }
		#endregion
