...
{
    public class UspRptCreditSummaryVendor
    {
        #region Private Members
        private string sp_Name = " UspRptCreditSummaryVendor";
        ...
        private decimal m_RELIZATION_LIMIT;
        private int m_CLAIMTYPE;
        //  private long m_MoneyFilter;
        #endregion


        #region Public Properties
        public decimal RELIZATION_LIMIT
        {
            set
            {
                m_RELIZATION_LIMIT = value;
            }
            get
            {
                return m_RELIZATION_LIMIT;
            }
        }
        ...
        #region Constructor
        public UspRptCreditSummaryVendor()
        {
            ...
            m_SALEPERSON_ID = Constants.IntNullValue;
            m_AREA_ID = Constants.IntNullValue;
            m_CREDIT_TYPE = Constants.IntNullValue;
            m_TAGID = Constants.IntNullValue;
            m_FROM_DATE = Constants.DateNullValue;
            m_TO_DATE = Constants.DateNullValue;
            m_RELIZATION_LIMIT = Constants.DecimalNullValue;
            m_CLAIMTYPE = Constants.IntNullValue;
            //   m_MoneyFilter = Constants.LongNullValue;
        }
        #endregion
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "UspRptCreditSummaryVendor";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "UspRptCreditSummaryVendor";
        ...
        public void FirstReader(IDataReader dr)
        {
            if (dr.Read())
            {
                ...
                m_RELIZATION_LIMIT = Convert.ToDecimal(dr["RELIZATION_LIMIT"]);
                m_CLAIMTYPE = Convert.ToInt32(dr["CLAIMTYPE"]);
                //   m_MoneyFilter = Convert.ToDouble(dr["sf"]);
            }
        }
        ...
        public void GetParameterCollection(ref IDbCommand cmd)
        {
            ...
            parameter.ParameterName = "@CLAIMTYPE";
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.Int);
            if (m_CLAIMTYPE == Constants.IntNullValue)
            {
                parameter.Value = DBNull.Value;
            }
            else
            {
                parameter.Value = m_CLAIMTYPE;
            }
            ...
            parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
            parameter.ParameterName = "@RELIZATION_LIMIT";
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.Money);
            if (m_RELIZATION_LIMIT == Constants.DecimalNullValue)
            {
                parameter.Value = DBNull.Value;
            }
            else
            {
                parameter.Value = m_RELIZATION_LIMIT;
            }
            pparams.Add(parameter);
