...
{
	public class UspClaimDetailReport
	{
		#region Private Members
		private string sp_Name = " UspClaimDetailReport" ;
		...
		#region Constructor
		public UspClaimDetailReport()
		{
		m_DISTRIBUTOR_ID = Constants.IntNullValue;
		m_PRINCIPAL_ID = Constants.IntNullValue;
		m_CLAIM_TYPE = Constants.IntNullValue;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "UspClaimDetailReport";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "UspClaimDetailReport";
