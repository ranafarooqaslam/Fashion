...
{
	public class UspPrintCSDUSCInvoice
	{
		#region Private Members
		private string sp_Name = " UspPrintCSDUSCInvoice" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "UspPrintCSDUSCInvoice";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "UspPrintCSDUSCInvoice";
