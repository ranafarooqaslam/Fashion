...
{
	public class uspGetGLLogVoucherDetail
	{
		#region Private Members
		private string sp_Name = " uspGetGLLogVoucherDetail" ;
		...
		#region Constructor
		public uspGetGLLogVoucherDetail()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspGetGLLogVoucherDetail";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspGetGLLogVoucherDetail";
		...
		public void FirstReader(IDataReader dr)
			{
				if(dr.Read())
				{
                    ...
                    m_FILTER_ON = Convert.ToInt32(dr["FILTER_ON"]);
				}
			}
		...
		public void GetParameterCollection(ref IDbCommand cmd)
		{
            ...
            parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
            parameter.ParameterName = "@FILTER_ON";
            if (m_FILTER_ON == Constants.IntNullValue)
            {
                parameter.Value = DBNull.Value;
            }
            else
            {
                parameter.Value = m_FILTER_ON;
            }
            pparams.Add(parameter);
