...
{
	public class spUpdateUSER_TERRITORY
	{
		#region Private Members
		private string sp_Name = " spUpdateUSER_TERRITORY" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateUSER_TERRITORY";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateUSER_TERRITORY";
