...
{
	public class spDeleteDTWAREHOUSES
	{
		#region Private Members
		private string sp_Name = " spDeleteDTWAREHOUSES" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteDTWAREHOUSES";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteDTWAREHOUSES";
