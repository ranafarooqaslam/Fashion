...
{
	public class spInsertDTCHEQUE_ENTRY
	{
		#region Private Members
		private string sp_Name = " spInsertDTCHEQUE_ENTRY" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTCHEQUE_ENTRY";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTCHEQUE_ENTRY";
