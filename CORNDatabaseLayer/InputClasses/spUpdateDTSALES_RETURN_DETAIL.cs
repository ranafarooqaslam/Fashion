...
{
	public class spUpdateDTSALES_RETURN_DETAIL
	{
		#region Private Members
		private string sp_Name = " spUpdateDTSALES_RETURN_DETAIL" ;
		...
		public long SALES_RETURN_DETAIL_ID
		{
			set
			{
				m_SALES_RETURN_DETAIL_ID = value ;
			}
			get
			{
		...
		#region Constructor
		public spUpdateDTSALES_RETURN_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTSALES_RETURN_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTSALES_RETURN_DETAIL";
		...
		public string ExecuteScalar()
		{
			...
			public void FirstReader(IDataReader dr)
			{
				if(dr.Read())
				{
					...
					m_IS_DAMAGED=Convert.ToBoolean(dr["IS_DAMAGED"]);
		    ...
		    public void GetParameterCollection(ref IDbCommand cmd)
		{
			...
			if(m_SALES_RETURN_DETAIL_ID==Constants.LongNullValue)
			{
				parameter.Value = DBNull.Value;
			}
			else
			{
				parameter.Value = m_SALES_RETURN_DETAIL_ID;
			}
