...
{
	public class uspSelectPROMOTION_CUSTOMER_TYPE_dt
	{
		#region Private Members
		private string sp_Name = " uspSelectPROMOTION_CUSTOMER_TYPE_dt" ;
		...
		#region Constructor
		public uspSelectPROMOTION_CUSTOMER_TYPE_dt()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectPROMOTION_CUSTOMER_TYPE_dt";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectPROMOTION_CUSTOMER_TYPE_dt";
