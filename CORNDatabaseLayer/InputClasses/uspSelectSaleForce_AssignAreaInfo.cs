...
{
	public class uspSelectSaleForce_AssignAreaInfo
	{
		#region Private Members
		private string sp_Name = " uspSelectSaleForce_AssignAreaInfo" ;
		...
		#region Constructor
		public uspSelectSaleForce_AssignAreaInfo()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectSaleForce_AssignAreaInfo";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectSaleForce_AssignAreaInfo";
