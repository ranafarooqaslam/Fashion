...
{
	public class uspUpdateHHSaleOrderPromotion
	{
		#region Private Members
		private string sp_Name = " uspUpdateHHSaleOrderPromotion" ;
		private IDbConnection m_connection;
		private IDbTransaction m_transaction;


		private long m_HHSaleOrderPromotionId;
		...
		public long HHSaleOrderPromotionId
		{
			set
			{
		...
		#region Constructor
		public uspUpdateHHSaleOrderPromotion()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspUpdateHHSaleOrderPromotion";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspUpdateHHSaleOrderPromotion";
		...
		public string ExecuteScalar()
		{
			...
			public void FirstReader(IDataReader dr)
			{
				if(dr.Read())
				{
					m_HHSaleOrderPromotionId=Convert.ToInt64(dr["HHSaleOrderPromotionId"]);
		    ...
		    public void GetParameterCollection(ref IDbCommand cmd)
		{
			...
			if(m_HHSaleOrderPromotionId==Constants.LongNullValue)
			{
