...
{
	public class spInsertSTOCK_ADJUSTMENT_DETAIL
	{
		#region Private Members
		private string sp_Name = " spInsertSTOCK_ADJUSTMENT_DETAIL" ;
		...
		#region Constructor
		public spInsertSTOCK_ADJUSTMENT_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertSTOCK_ADJUSTMENT_DETAIL";
				...
				cmd.ExecuteNonQuery();
				m_STOCK_ADJUSTMENT_DETAIL_ID = (long)((IDataParameter)(cmd.Parameters["@STOCK_ADJUSTMENT_DETAIL_ID"])).Value;
				return true;
			}
			catch(Exception e)
			{
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertSTOCK_ADJUSTMENT_DETAIL";
