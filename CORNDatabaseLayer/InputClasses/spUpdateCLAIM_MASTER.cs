...
{
	public class spUpdateCLAIM_MASTER
	{
		#region Private Members
		private string sp_Name = " spUpdateCLAIM_MASTER" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateCLAIM_MASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateCLAIM_MASTER";
