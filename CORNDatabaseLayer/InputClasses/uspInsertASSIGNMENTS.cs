...
{
	public class uspInsertASSIGNMENTS
	{
		#region Private Members
		private string sp_Name = " uspInsertASSIGNMENTS" ;
		private IDbConnection m_connection;
		private IDbTransaction m_transaction;


		private bool m_IS_ACCTIVE;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspInsertASSIGNMENTS";
				...
				cmd.ExecuteNonQuery();
				m_ASSIGNMENTS_ID = (int)((IDataParameter)(cmd.Parameters["@ASSIGNMENTS_ID"])).Value;
				return true;
			}
			catch(Exception e)
			{
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspInsertASSIGNMENTS";
		...
		public string ExecuteScalar()
		{
			...
			public void FirstReader(IDataReader dr)
			{
				if(dr.Read())
				{
					m_IS_ACCTIVE=Convert.ToBoolean(dr["IS_ACCTIVE"]);
