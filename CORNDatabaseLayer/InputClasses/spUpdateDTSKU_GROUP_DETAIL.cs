...
{
	public class spUpdateDTSKU_GROUP_DETAIL
	{
		#region Private Members
		private string sp_Name = " spUpdateDTSKU_GROUP_DETAIL" ;
		...
		#region Constructor
		public spUpdateDTSKU_GROUP_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTSKU_GROUP_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTSKU_GROUP_DETAIL";
