...
{
	public class spDeleteDTSALE_INVOICE_MASTER
	{
		#region Private Members
		private string sp_Name = " spDeleteDTSALE_INVOICE_MASTER" ;
		...
		#region Constructor
		public spDeleteDTSALE_INVOICE_MASTER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteDTSALE_INVOICE_MASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteDTSALE_INVOICE_MASTER";
