...
{
	public class spPROCESSPROMOTION_OFFER
	{
		#region Private Members
		private string sp_Name = " spPROCESSPROMOTION_OFFER" ;
		...
		#region Constructor
		public spPROCESSPROMOTION_OFFER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spPROCESSPROMOTION_OFFER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spPROCESSPROMOTION_OFFER";
		...
		public string ExecuteScalar()
		{
			...
			public void FirstReader(IDataReader dr)
			{
				if(dr.Read())
				{
					...
					m_DISCOUNT= float.Parse(dr["DISCOUNT"].ToString());
