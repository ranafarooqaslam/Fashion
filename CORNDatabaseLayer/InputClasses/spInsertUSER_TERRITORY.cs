...
{
	public class spInsertUSER_TERRITORY
	{
		#region Private Members
		private string sp_Name = " spInsertUSER_TERRITORY" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertUSER_TERRITORY";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertUSER_TERRITORY";
