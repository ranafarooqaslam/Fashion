...
{
	public class spInsertDTDISTRIBUTOR_TOWN
	{
		#region Private Members
		private string sp_Name = " spInsertDTDISTRIBUTOR_TOWN" ;
		...
		#region Constructor
		public spInsertDTDISTRIBUTOR_TOWN()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTDISTRIBUTOR_TOWN";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTDISTRIBUTOR_TOWN";
