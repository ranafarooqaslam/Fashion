...
{
	public class spSelectSALEFORCE_PRINCIPAL_ASSIGNMENT
	{
		#region Private Members
		private string sp_Name = " spSelectSALEFORCE_PRINCIPAL_ASSIGNMENT" ;
		...
		#region Constructor
		public spSelectSALEFORCE_PRINCIPAL_ASSIGNMENT()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectSALEFORCE_PRINCIPAL_ASSIGNMENT";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectSALEFORCE_PRINCIPAL_ASSIGNMENT";
