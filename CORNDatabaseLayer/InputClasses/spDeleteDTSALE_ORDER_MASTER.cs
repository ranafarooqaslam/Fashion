...
{
	public class spDeleteDTSALE_ORDER_MASTER
	{
		#region Private Members
		private string sp_Name = " spDeleteDTSALE_ORDER_MASTER" ;
		...
		#region Constructor
		public spDeleteDTSALE_ORDER_MASTER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteDTSALE_ORDER_MASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteDTSALE_ORDER_MASTER";
