...
{
	public class uspSelectSALE_ORDER_DETAIL
	{
		#region Private Members
		private string sp_Name = " uspSelectSALE_ORDER_DETAIL" ;
		...
		#region Constructor
		public uspSelectSALE_ORDER_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectSALE_ORDER_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectSALE_ORDER_DETAIL";
