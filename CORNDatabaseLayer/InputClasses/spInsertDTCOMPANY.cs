...
{
	public class spInsertDTCOMPANY
	{
		#region Private Members
		private string sp_Name = " spInsertDTCOMPANY" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTCOMPANY";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTCOMPANY";
