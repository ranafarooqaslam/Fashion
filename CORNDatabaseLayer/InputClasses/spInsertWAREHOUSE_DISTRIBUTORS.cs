...
{
	public class spInsertWAREHOUSE_DISTRIBUTORS
	{
		#region Private Members
		private string sp_Name = " spInsertWAREHOUSE_DISTRIBUTORS" ;
		...
		#region Constructor
		public spInsertWAREHOUSE_DISTRIBUTORS()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertWAREHOUSE_DISTRIBUTORS";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertWAREHOUSE_DISTRIBUTORS";
