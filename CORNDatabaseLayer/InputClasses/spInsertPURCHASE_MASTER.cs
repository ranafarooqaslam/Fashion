...
namespace CORNDatabaseLayer.Classes
{
    public class spInsertPURCHASE_MASTER
    {
        ...
        public spInsertPURCHASE_MASTER()
        {
            ...
            m_TOTAL_AMOUNT = Constants.DecimalNullValue;
            ...
            m_isClosed = Constants.ShortNullValue;
            m_DISCOUNT = 0;
        }
        #endregion
        ...
        public void GetParameterCollection(ref IDbCommand cmd)
        {
            ...
            parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
            parameter.ParameterName = "@isClosed";
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.TinyInt);
            if (m_isClosed == Constants.ShortNullValue)
            {
                parameter.Value = DBNull.Value;
            }
            else
            {
                parameter.Value = m_isClosed;
            }
