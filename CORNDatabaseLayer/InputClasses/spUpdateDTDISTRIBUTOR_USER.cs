...
{
	public class spUpdateDTDISTRIBUTOR_USER
	{
		#region Private Members
		private string sp_Name = " spUpdateDTDISTRIBUTOR_USER" ;
		...
		#region Constructor
		public spUpdateDTDISTRIBUTOR_USER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTDISTRIBUTOR_USER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTDISTRIBUTOR_USER";
