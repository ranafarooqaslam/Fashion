...
{
	public class spInsertDTLOYALTY_FOR_CUSTOMER
	{
		#region Private Members
		private string sp_Name = " spInsertDTLOYALTY_FOR_CUSTOMER" ;
		...
		#region Constructor
		public spInsertDTLOYALTY_FOR_CUSTOMER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTLOYALTY_FOR_CUSTOMER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTLOYALTY_FOR_CUSTOMER";
