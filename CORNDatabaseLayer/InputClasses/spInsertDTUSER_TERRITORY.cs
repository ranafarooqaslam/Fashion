...
{
	public class spInsertDTUSER_TERRITORY
	{
		#region Private Members
		private string sp_Name = " spInsertDTUSER_TERRITORY" ;
		...
		#region Constructor
		public spInsertDTUSER_TERRITORY()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTUSER_TERRITORY";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTUSER_TERRITORY";
