...
{
	public class spInsertDTPURCHASE_MASTER
	{
		#region Private Members
		private string sp_Name = " spInsertDTPURCHASE_MASTER" ;
		...
		#region Constructor
		public spInsertDTPURCHASE_MASTER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTPURCHASE_MASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTPURCHASE_MASTER";
		...
		public string ExecuteScalar()
		{
			...
			public void FirstReader(IDataReader dr)
			{
				if(dr.Read())
				{
					...
					m_POSTING=Convert.ToBoolean(dr["POSTING"]);
