...
{
	public class uspSelectPendingOrders
	{
		#region Private Members
		private string sp_Name = " uspSelectPendingOrders" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectPendingOrders";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectPendingOrders";
