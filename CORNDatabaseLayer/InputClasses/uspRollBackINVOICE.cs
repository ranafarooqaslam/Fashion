...
{
	public class uspRollBackINVOICE
	{
		#region Private Members
		private string sp_Name = " uspRollBackINVOICE" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspRollBackINVOICE";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspRollBackINVOICE";
