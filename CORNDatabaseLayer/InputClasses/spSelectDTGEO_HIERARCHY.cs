...
{
	public class spSelectDTGEO_HIERARCHY
	{
		#region Private Members
		private string sp_Name = " spSelectDTGEO_HIERARCHY" ;
		...
		#region Constructor
		public spSelectDTGEO_HIERARCHY()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectDTGEO_HIERARCHY";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectDTGEO_HIERARCHY";
