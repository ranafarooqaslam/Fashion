...
{
	public class uspSelectAreaName
	{
		#region Private Members
		private string sp_Name = " uspSelectAreaName" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectAreaName";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectAreaName";
