...
{
	public class spInsertCLAIM_DETAIL
	{
		#region Private Members
		private string sp_Name = " spInsertCLAIM_DETAIL" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertCLAIM_DETAIL";
				...
				cmd.ExecuteNonQuery();
				m_CLAIM_DETAIL_ID = (long)((IDataParameter)(cmd.Parameters["@CLAIM_DETAIL_ID"])).Value;
				return true;
			}
			catch(Exception e)
			{
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertCLAIM_DETAIL";
