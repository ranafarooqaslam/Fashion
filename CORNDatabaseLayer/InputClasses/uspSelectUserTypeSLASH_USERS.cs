...
{
	public class uspSelectUserTypeSAMS_USERS
	{
		#region Private Members
		private string sp_Name = " uspSelectUserTypeSAMS_USERS" ;
		...
		#region Constructor
		public uspSelectUserTypeSAMS_USERS()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectUserTypeSAMS_USERS";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectUserTypeSAMS_USERS";
