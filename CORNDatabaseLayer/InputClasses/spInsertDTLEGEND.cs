...
{
	public class spInsertDTLEGEND
	{
		#region Private Members
		private string sp_Name = " spInsertDTLEGEND" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTLEGEND";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTLEGEND";
