...
{
	public class spDeletePAYSICAL_STOCK
	{
		#region Private Members
		private string sp_Name = " spDeletePAYSICAL_STOCK" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeletePAYSICAL_STOCK";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeletePAYSICAL_STOCK";
