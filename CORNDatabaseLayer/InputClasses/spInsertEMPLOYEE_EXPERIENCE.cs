...
{
    public class spInsertEMPLOYEE_EXPERIENCE
    {
        #region Private Members
        private string sp_Name = " spInsertEMPLOYEE_EXPERIENCE";
        ...
        #region Constructor
        public spInsertEMPLOYEE_EXPERIENCE()
        {
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "spInsertEMPLOYEE_EXPERIENCE";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "spInsertEMPLOYEE_EXPERIENCE";
