...
{
	public class spInsertCLAIM_MASTER
	{
		#region Private Members
		private string sp_Name = " spInsertCLAIM_MASTER" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertCLAIM_MASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertCLAIM_MASTER";
