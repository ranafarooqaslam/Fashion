...
{
	public class UspSelectInvoiceBuiltyInfo
	{
		#region Private Members
		private string sp_Name = " UspSelectInvoiceBuiltyInfo" ;
		...
		#region Constructor
		public UspSelectInvoiceBuiltyInfo()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "UspSelectInvoiceBuiltyInfo";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "UspSelectInvoiceBuiltyInfo";
