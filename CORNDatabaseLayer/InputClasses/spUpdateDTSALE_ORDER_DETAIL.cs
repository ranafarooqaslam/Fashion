...
{
	public class spUpdateDTSALE_ORDER_DETAIL
	{
		#region Private Members
		private string sp_Name = " spUpdateDTSALE_ORDER_DETAIL" ;
		...
		#region Constructor
		public spUpdateDTSALE_ORDER_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTSALE_ORDER_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTSALE_ORDER_DETAIL";
