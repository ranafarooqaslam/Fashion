...
{
	public class usp_orderbooker_Ordered
	{
		#region Private Members
		private string sp_Name = " usp_orderbooker_Ordered" ;
		...
		#region Constructor
		public usp_orderbooker_Ordered()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "usp_orderbooker_Ordered";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "usp_orderbooker_Ordered";
