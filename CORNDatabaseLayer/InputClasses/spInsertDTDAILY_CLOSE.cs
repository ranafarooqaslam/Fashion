...
{
	public class spInsertDTDAILY_CLOSE
	{
		#region Private Members
		private string sp_Name = " spInsertDTDAILY_CLOSE" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTDAILY_CLOSE";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTDAILY_CLOSE";
