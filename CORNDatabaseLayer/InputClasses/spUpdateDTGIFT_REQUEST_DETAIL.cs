...
{
	public class spUpdateDTGIFT_REQUEST_DETAIL
	{
		#region Private Members
		private string sp_Name = " spUpdateDTGIFT_REQUEST_DETAIL" ;
		...
		#region Constructor
		public spUpdateDTGIFT_REQUEST_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTGIFT_REQUEST_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTGIFT_REQUEST_DETAIL";
