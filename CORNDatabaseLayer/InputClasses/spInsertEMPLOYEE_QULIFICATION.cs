...
{
    public class spInsertEMPLOYEE_QULIFICATION
    {
        #region Private Members
        private string sp_Name = " spInsertEMPLOYEE_QULIFICATION";
        ...
        #region Constructor
        public spInsertEMPLOYEE_QULIFICATION()
        {
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "spInsertEMPLOYEE_QULIFICATION";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "spInsertEMPLOYEE_QULIFICATION";
