...
{
	public class UspReconcilationReport
	{
		#region Private Members
		private string sp_Name = " UspReconcilationReport" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "UspReconcilationReport";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "UspReconcilationReport";
