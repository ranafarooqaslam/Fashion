...
{
	public class spDeleteDTLEDGER
	{
		#region Private Members
		private string sp_Name = " spDeleteDTLEDGER" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteDTLEDGER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteDTLEDGER";
