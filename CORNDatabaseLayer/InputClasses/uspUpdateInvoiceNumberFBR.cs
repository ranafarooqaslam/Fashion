...
{
    public class uspUpdateInvoiceNumberFBR
    {
        #region Private Members
        private string sp_Name = " uspUpdateInvoiceNumberFBR";
        ...
        public string InvoiceNumberFBR
        {
            set
            {
                m_InvoiceNumberFBR = value;
            }
            get
            {
                return m_InvoiceNumberFBR;
            }
        }
        ...
        #region Constructor
        public uspUpdateInvoiceNumberFBR()
        {
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "uspUpdateInvoiceNumberFBR";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "uspUpdateInvoiceNumberFBR";
