...
{
	public class spDeleteSTOCK_ADJUSTMENT
	{
		#region Private Members
		private string sp_Name = " spDeleteSTOCK_ADJUSTMENT" ;
		...
		#region Constructor
		public spDeleteSTOCK_ADJUSTMENT()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteSTOCK_ADJUSTMENT";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteSTOCK_ADJUSTMENT";
