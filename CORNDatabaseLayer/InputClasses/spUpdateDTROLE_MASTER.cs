...
{
	public class spUpdateDTROLE_MASTER
	{
		#region Private Members
		private string sp_Name = " spUpdateDTROLE_MASTER" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTROLE_MASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTROLE_MASTER";
		...
		public string ExecuteScalar()
		{
			...
			public void FirstReader(IDataReader dr)
			{
				if(dr.Read())
				{
					...
					m_ROLE_NAME= Convert.ToString(dr["ROLE_NAME"]);
