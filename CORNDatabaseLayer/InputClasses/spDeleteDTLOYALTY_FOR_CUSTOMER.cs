...
{
	public class spDeleteDTLOYALTY_FOR_CUSTOMER
	{
		#region Private Members
		private string sp_Name = " spDeleteDTLOYALTY_FOR_CUSTOMER" ;
		...
		#region Constructor
		public spDeleteDTLOYALTY_FOR_CUSTOMER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteDTLOYALTY_FOR_CUSTOMER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteDTLOYALTY_FOR_CUSTOMER";
