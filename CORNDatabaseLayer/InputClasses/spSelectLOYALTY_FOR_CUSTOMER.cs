...
{
	public class spSelectLOYALTY_FOR_CUSTOMER
	{
		#region Private Members
		private string sp_Name = " spSelectLOYALTY_FOR_CUSTOMER" ;
		...
		#region Constructor
		public spSelectLOYALTY_FOR_CUSTOMER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectLOYALTY_FOR_CUSTOMER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectLOYALTY_FOR_CUSTOMER";
