...
{
	public class spInsertDTSTOCK_ADJUSTMENT_DETAIL
	{
		#region Private Members
		private string sp_Name = " spInsertDTSTOCK_ADJUSTMENT_DETAIL" ;
		...
		#region Constructor
		public spInsertDTSTOCK_ADJUSTMENT_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTSTOCK_ADJUSTMENT_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTSTOCK_ADJUSTMENT_DETAIL";
