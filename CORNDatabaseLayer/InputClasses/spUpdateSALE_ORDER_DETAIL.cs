...
{
	public class spUpdateSALE_ORDER_DETAIL
	{
		#region Private Members
		private string sp_Name = " spUpdateSALE_ORDER_DETAIL" ;
		...
		#region Constructor
		public spUpdateSALE_ORDER_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateSALE_ORDER_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateSALE_ORDER_DETAIL";
