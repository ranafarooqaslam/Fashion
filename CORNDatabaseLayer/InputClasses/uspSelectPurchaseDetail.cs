...
{
	public class uspSelectPurchaseDetail
	{
		#region Private Members
		private string sp_Name = " uspSelectPurchaseDetail" ;
		...
		#region Constructor
		public uspSelectPurchaseDetail()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectPurchaseDetail";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectPurchaseDetail";
