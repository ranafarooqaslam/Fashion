...
{
	public class spUpdateDTLEGEND
	{
		#region Private Members
		private string sp_Name = " spUpdateDTLEGEND" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTLEGEND";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTLEGEND";
