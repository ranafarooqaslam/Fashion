...
{
    public class UspBillWiseInvoiceReport
    {
        #region Private Members
        private string sp_Name = "UspBillWiseInvoiceReport";
        ...
        #endregion
        #region Constructor
        public UspBillWiseInvoiceReport()
        {
        }
        #endregion
        ...
        public void FirstReader(IDataReader dr)
        {
            if (dr.Read())
            {
                ...
                m_SALE_INVOICE_ID = Convert.ToString(dr["SALE_INVOICE_ID"]);
            }
        }
