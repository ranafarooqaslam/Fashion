...
{
	public class spSelectEMPLOYEE_ROLEDETAIL
	{
		#region Private Members
		private string sp_Name = " spSelectEMPLOYEE_ROLEDETAIL" ;
		...
		#region Constructor
		public spSelectEMPLOYEE_ROLEDETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectEMPLOYEE_ROLEDETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectEMPLOYEE_ROLEDETAIL";
