...
{
	public class uspSelectSALE_INVOICE_MASTER
	{
		#region Private Members
		private string sp_Name = " uspSelectSALE_INVOICE_MASTER" ;
		...
		#region Constructor
		public uspSelectSALE_INVOICE_MASTER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectSALE_INVOICE_MASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectSALE_INVOICE_MASTER";
