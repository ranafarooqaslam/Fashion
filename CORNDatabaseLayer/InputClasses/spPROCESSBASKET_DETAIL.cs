...
{
	public class spPROCESSBASKET_DETAIL
	{
		#region Private Members
		private string sp_Name = " spPROCESSBASKET_DETAIL" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spPROCESSBASKET_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spPROCESSBASKET_DETAIL";
