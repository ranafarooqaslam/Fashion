...
{
	public class spInsertDTPROMOTION_FOR
	{
		#region Private Members
		private string sp_Name = " spInsertDTPROMOTION_FOR" ;
		...
		#region Constructor
		public spInsertDTPROMOTION_FOR()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTPROMOTION_FOR";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTPROMOTION_FOR";
