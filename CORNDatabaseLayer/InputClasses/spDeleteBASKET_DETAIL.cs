...
{
	public class spDeleteBASKET_DETAIL
	{
		#region Private Members
		private string sp_Name = " spDeleteBASKET_DETAIL" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteBASKET_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteBASKET_DETAIL";
