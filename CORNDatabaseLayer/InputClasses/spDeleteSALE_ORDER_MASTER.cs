...
{
	public class spDeleteSALE_ORDER_MASTER
	{
		#region Private Members
		private string sp_Name = " spDeleteSALE_ORDER_MASTER" ;
		...
		#region Constructor
		public spDeleteSALE_ORDER_MASTER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteSALE_ORDER_MASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteSALE_ORDER_MASTER";
