...
{
	public class uspSelectDeliveryManByAreaRoute
	{
		#region Private Members
		private string sp_Name = " uspSelectDeliveryManByAreaRoute" ;
		...
		#region Constructor
		public uspSelectDeliveryManByAreaRoute()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectDeliveryManByAreaRoute";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectDeliveryManByAreaRoute";
