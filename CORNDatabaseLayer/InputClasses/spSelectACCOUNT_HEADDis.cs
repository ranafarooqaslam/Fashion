...
{
    public class spSelectACCOUNT_HEADDis
    {
        #region Private Members
        private string sp_Name = "spSelectACCOUNT_HEADDis";
        ...
        #region Constructor
        public spSelectACCOUNT_HEADDis()
        {
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "spSelectACCOUNT_HEADDis";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "spSelectACCOUNT_HEADDis";
