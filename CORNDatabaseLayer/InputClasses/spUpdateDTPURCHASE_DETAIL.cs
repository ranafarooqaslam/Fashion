...
{
	public class spUpdateDTPURCHASE_DETAIL
	{
		#region Private Members
		private string sp_Name = " spUpdateDTPURCHASE_DETAIL" ;
		...
		#region Constructor
		public spUpdateDTPURCHASE_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTPURCHASE_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTPURCHASE_DETAIL";
