...
{
	public class spSelectSKU_TAX
	{
		#region Private Members
		private string sp_Name = " spSelectSKU_TAX" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectSKU_TAX";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectSKU_TAX";
