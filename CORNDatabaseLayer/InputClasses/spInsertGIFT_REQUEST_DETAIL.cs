...
{
	public class spInsertGIFT_REQUEST_DETAIL
	{
		#region Private Members
		private string sp_Name = " spInsertGIFT_REQUEST_DETAIL" ;
		...
		#region Constructor
		public spInsertGIFT_REQUEST_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertGIFT_REQUEST_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertGIFT_REQUEST_DETAIL";
