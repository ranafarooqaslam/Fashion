...
{
	public class spInsertDTSKU_TAX
	{
		#region Private Members
		private string sp_Name = " spInsertDTSKU_TAX" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTSKU_TAX";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTSKU_TAX";
