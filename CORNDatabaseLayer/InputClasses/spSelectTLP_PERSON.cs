...
{
	public class spSelectTLP_PERSON
	{
		#region Private Members
		private string sp_Name = " spSelectTLP_PERSON" ;
		...
		#region Constructor
		public spSelectTLP_PERSON()
		{
		m_TLP_PERSON_ID = Constants.LongNullValue;
		m_IS_ACTIVE = true;
		m_DATE_OF_REGISTRATION = Constants.DateNullValue;
		m_TIME_STAMP = Constants.DateNullValue;
		m_LASTUPDATE_DATE = Constants.DateNullValue;;
		m_BALANCE_POINT = Constants.DecimalNullValue; 
		m_TOTAL_POINT = Constants.DecimalNullValue;
		m_USED_POINT = Constants.DecimalNullValue;
		m_REDEMPTED_POINT = Constants.DecimalNullValue;
		m_USER_ID = Constants.IntNullValue;
		m_TLP_PERSON_CODE = null;
		m_TLP_PERSON_NAME = null;
		m_NIC = null;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectTLP_PERSON";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectTLP_PERSON";
