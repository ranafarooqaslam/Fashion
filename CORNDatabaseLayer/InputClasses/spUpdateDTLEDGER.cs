...
{
	public class spUpdateDTLEDGER
	{
		#region Private Members
		private string sp_Name = " spUpdateDTLEDGER" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTLEDGER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTLEDGER";
