...
{
    public class spInsertEMPLOYEE_REFERENCE
    {
        #region Private Members
        private string sp_Name = " spInsertEMPLOYEE_REFERENCE";
        ...
        #region Constructor
        public spInsertEMPLOYEE_REFERENCE()
        {
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "spInsertEMPLOYEE_REFERENCE";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "spInsertEMPLOYEE_REFERENCE";
