...
{
	public class UspfinalsaleDetailView
	{
		#region Private Members
		private string sp_Name = " UspfinalsaleDetailView" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "UspfinalsaleDetailView";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "UspfinalsaleDetailView";
