...
{
	public class spUpdateDTSKU_STOCK
	{
		#region Private Members
		private string sp_Name = " spUpdateDTSKU_STOCK" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTSKU_STOCK";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTSKU_STOCK";
