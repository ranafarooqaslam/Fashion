...
{
	public class spInsertDTSALES_RETURN_MASTER
	{
		#region Private Members
		private string sp_Name = " spInsertDTSALES_RETURN_MASTER" ;
		...
		#region Constructor
		public spInsertDTSALES_RETURN_MASTER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTSALES_RETURN_MASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTSALES_RETURN_MASTER";
