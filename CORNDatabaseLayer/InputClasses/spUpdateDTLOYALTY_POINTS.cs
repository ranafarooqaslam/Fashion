...
{
	public class spUpdateDTLOYALTY_POINTS
	{
		#region Private Members
		private string sp_Name = " spUpdateDTLOYALTY_POINTS" ;
		...
		#region Constructor
		public spUpdateDTLOYALTY_POINTS()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTLOYALTY_POINTS";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTLOYALTY_POINTS";
