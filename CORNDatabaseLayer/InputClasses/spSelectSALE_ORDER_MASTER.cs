...
{
	public class spSelectSALE_ORDER_MASTER
	{
		#region Private Members
		private string sp_Name = " spSelectSALE_ORDER_MASTER" ;
		...
		#region Constructor
		public spSelectSALE_ORDER_MASTER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectSALE_ORDER_MASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectSALE_ORDER_MASTER";
