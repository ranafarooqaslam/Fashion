...
{
	public class spInsertDISTRIBUTOR_USER_TERRITORY
	{
		#region Private Members
		private string sp_Name = " spInsertDISTRIBUTOR_USER_TERRITORY" ;
		...
		#region Constructor
		public spInsertDISTRIBUTOR_USER_TERRITORY()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDISTRIBUTOR_USER_TERRITORY";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDISTRIBUTOR_USER_TERRITORY";
