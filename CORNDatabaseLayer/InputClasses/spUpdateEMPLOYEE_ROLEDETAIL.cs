...
{
	public class spUpdateEMPLOYEE_ROLEDETAIL
	{
		#region Private Members
		private string sp_Name = " spUpdateEMPLOYEE_ROLEDETAIL" ;
		...
		#region Constructor
		public spUpdateEMPLOYEE_ROLEDETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateEMPLOYEE_ROLEDETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateEMPLOYEE_ROLEDETAIL";
