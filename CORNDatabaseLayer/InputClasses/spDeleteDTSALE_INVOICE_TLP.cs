...
{
	public class spDeleteDTSALE_INVOICE_TLP
	{
		#region Private Members
		private string sp_Name = " spDeleteDTSALE_INVOICE_TLP" ;
		...
		#region Constructor
		public spDeleteDTSALE_INVOICE_TLP()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteDTSALE_INVOICE_TLP";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteDTSALE_INVOICE_TLP";
