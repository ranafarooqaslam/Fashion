...
{
	public class spInsertSCHEME
	{
		#region Private Members
		private string sp_Name = " spInsertSCHEME" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertSCHEME";
				...
				cmd.ExecuteNonQuery();
				m_SCHEME_ID = (int)((IDataParameter)(cmd.Parameters["@SCHEME_ID"])).Value;
				return true;
			}
			catch(Exception e)
			{
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertSCHEME";
