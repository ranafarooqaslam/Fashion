...
{
	public class spSelectBASKET_DETAIL
	{
		#region Private Members
		private string sp_Name = " spSelectBASKET_DETAIL" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectBASKET_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectBASKET_DETAIL";
