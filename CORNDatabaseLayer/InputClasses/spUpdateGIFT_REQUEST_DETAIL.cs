...
{
	public class spUpdateGIFT_REQUEST_DETAIL
	{
		#region Private Members
		private string sp_Name = " spUpdateGIFT_REQUEST_DETAIL" ;
		...
		#region Constructor
		public spUpdateGIFT_REQUEST_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateGIFT_REQUEST_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateGIFT_REQUEST_DETAIL";
