...
{
	public class spUpdateDTMerchandizing_Items_Assignment
	{
		#region Private Members
		private string sp_Name = " spUpdateDTMerchandizing_Items_Assignment" ;
		...
		#region Constructor
		public spUpdateDTMerchandizing_Items_Assignment()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTMerchandizing_Items_Assignment";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTMerchandizing_Items_Assignment";
