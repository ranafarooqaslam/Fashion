...
{
	public class spDeleteTLP_PERSON
	{
		#region Private Members
		private string sp_Name = " spDeleteTLP_PERSON" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteTLP_PERSON";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteTLP_PERSON";
