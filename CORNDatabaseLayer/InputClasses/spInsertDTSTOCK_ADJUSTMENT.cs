...
{
	public class spInsertDTSTOCK_ADJUSTMENT
	{
		#region Private Members
		private string sp_Name = " spInsertDTSTOCK_ADJUSTMENT" ;
		...
		#region Constructor
		public spInsertDTSTOCK_ADJUSTMENT()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTSTOCK_ADJUSTMENT";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTSTOCK_ADJUSTMENT";
