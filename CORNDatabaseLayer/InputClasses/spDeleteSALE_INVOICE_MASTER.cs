...
{
	public class spDeleteSALE_INVOICE_MASTER
	{
		#region Private Members
		private string sp_Name = " spDeleteSALE_INVOICE_MASTER" ;
		...
		#region Constructor
		public spDeleteSALE_INVOICE_MASTER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteSALE_INVOICE_MASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteSALE_INVOICE_MASTER";
