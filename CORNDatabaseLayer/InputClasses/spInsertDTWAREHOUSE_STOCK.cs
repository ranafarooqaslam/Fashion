...
{
	public class spInsertDTWAREHOUSE_STOCK
	{
		#region Private Members
		private string sp_Name = " spInsertDTWAREHOUSE_STOCK" ;
		...
		#region Constructor
		public spInsertDTWAREHOUSE_STOCK()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTWAREHOUSE_STOCK";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTWAREHOUSE_STOCK";
