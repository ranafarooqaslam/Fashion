...
{
	public class spInsertDTUSER_AREA
	{
		#region Private Members
		private string sp_Name = " spInsertDTUSER_AREA" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTUSER_AREA";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTUSER_AREA";
