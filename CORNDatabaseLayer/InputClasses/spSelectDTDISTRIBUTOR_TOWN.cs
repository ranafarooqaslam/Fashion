...
{
	public class spSelectDTDISTRIBUTOR_TOWN
	{
		#region Private Members
		private string sp_Name = " spSelectDTDISTRIBUTOR_TOWN" ;
		...
		#region Constructor
		public spSelectDTDISTRIBUTOR_TOWN()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectDTDISTRIBUTOR_TOWN";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectDTDISTRIBUTOR_TOWN";
