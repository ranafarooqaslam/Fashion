...
{
	public class spSelectUSER_TERRITORY
	{
		#region Private Members
		private string sp_Name = " spSelectUSER_TERRITORY" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectUSER_TERRITORY";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectUSER_TERRITORY";
