...
{
	public class spSelectSALE_INVOICE_PROMOTION
	{
		#region Private Members
		private string sp_Name = " spSelectSALE_INVOICE_PROMOTION" ;
		...
		#region Constructor
		public spSelectSALE_INVOICE_PROMOTION()
		{
		    ...
		    m_GST_AMOUNT = Constants.DecimalNullValue;
		    m_GST_RATE = Constants.FloatNullValue;
		    m_SALE_INVOICE_PROMOTION_ID= Constants.LongNullValue;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectSALE_INVOICE_PROMOTION";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectSALE_INVOICE_PROMOTION";
