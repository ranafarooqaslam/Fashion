...
{
	public class spInsertDTPROMOTION_CUSTOMER_TYPE
	{
		#region Private Members
		private string sp_Name = " spInsertDTPROMOTION_CUSTOMER_TYPE" ;
		...
		#region Constructor
		public spInsertDTPROMOTION_CUSTOMER_TYPE()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTPROMOTION_CUSTOMER_TYPE";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTPROMOTION_CUSTOMER_TYPE";
