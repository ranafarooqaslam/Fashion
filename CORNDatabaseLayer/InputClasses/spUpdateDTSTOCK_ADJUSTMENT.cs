...
{
	public class spUpdateDTSTOCK_ADJUSTMENT
	{
		#region Private Members
		private string sp_Name = " spUpdateDTSTOCK_ADJUSTMENT" ;
		...
		#region Constructor
		public spUpdateDTSTOCK_ADJUSTMENT()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTSTOCK_ADJUSTMENT";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTSTOCK_ADJUSTMENT";
