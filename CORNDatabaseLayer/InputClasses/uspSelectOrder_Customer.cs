...
{
	public class uspSelectOrder_Customer
	{
		#region Private Members
		private string sp_Name = " uspSelectOrder_Customer" ;
		...
		#region Constructor
		public uspSelectOrder_Customer()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectOrder_Customer";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectOrder_Customer";
