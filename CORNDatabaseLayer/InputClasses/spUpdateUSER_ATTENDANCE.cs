...
{
	public class spUpdateUSER_ATTENDANCE
	{
		#region Private Members
		private string sp_Name = " spUpdateUSER_ATTENDANCE" ;
		...
		#region Constructor
		public spUpdateUSER_ATTENDANCE()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateUSER_ATTENDANCE";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateUSER_ATTENDANCE";
