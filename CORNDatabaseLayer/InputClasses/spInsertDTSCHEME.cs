...
{
	public class spInsertDTSCHEME
	{
		#region Private Members
		private string sp_Name = " spInsertDTSCHEME" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTSCHEME";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTSCHEME";
