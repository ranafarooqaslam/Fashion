...
{
	public class uspSelectRolesInfo
	{
		#region Private Members
		private string sp_Name = " uspSelectRolesInfo" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectRolesInfo";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectRolesInfo";
