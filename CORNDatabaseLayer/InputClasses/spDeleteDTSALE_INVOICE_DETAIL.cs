...
{
	public class spDeleteDTSALE_INVOICE_DETAIL
	{
		#region Private Members
		private string sp_Name = " spDeleteDTSALE_INVOICE_DETAIL" ;
		...
		#region Constructor
		public spDeleteDTSALE_INVOICE_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteDTSALE_INVOICE_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteDTSALE_INVOICE_DETAIL";
