...
{
    public class spInsertPURCHASE_DETAILDecimal
    {
        #region Private Members
        private string sp_Name = " spInsertPURCHASE_DETAILDecimal";
        ...
        #region Constructor
        public spInsertPURCHASE_DETAILDecimal()
        {
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "spInsertPURCHASE_DETAILDecimal";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "spInsertPURCHASE_DETAILDecimal";
