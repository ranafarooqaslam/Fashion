...
{
	public class spUpdateDISTRIBUTOR_AREA
	{
		#region Private Members
		private string sp_Name = " spUpdateDISTRIBUTOR_AREA" ;
		...
		#region Constructor
		public spUpdateDISTRIBUTOR_AREA()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDISTRIBUTOR_AREA";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDISTRIBUTOR_AREA";
