...
{
	public class spInsertCUSTOMER_HIERARCHY
	{
		#region Private Members
		private string sp_Name = " spInsertCUSTOMER_HIERARCHY" ;
		...
		#region Constructor
		public spInsertCUSTOMER_HIERARCHY()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertCUSTOMER_HIERARCHY";
				...
				cmd.ExecuteNonQuery();
				m_CUSTOMER_ID = (int)((IDataParameter)(cmd.Parameters["@CUSTOMER_ID"])).Value;
				return true;
			}
			catch(Exception e)
			{
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertCUSTOMER_HIERARCHY";
