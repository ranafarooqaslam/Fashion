...
{
	public class spDeleteDTSTOCK_ADJUSTMENT
	{
		#region Private Members
		private string sp_Name = " spDeleteDTSTOCK_ADJUSTMENT" ;
		...
		#region Constructor
		public spDeleteDTSTOCK_ADJUSTMENT()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteDTSTOCK_ADJUSTMENT";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteDTSTOCK_ADJUSTMENT";
