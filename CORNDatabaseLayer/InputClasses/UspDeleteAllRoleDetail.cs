...
{
	public class UspDeleteAllRoleDetail
	{
		#region Private Members
		private string sp_Name = " UspDeleteAllRoleDetail" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "UspDeleteAllRoleDetail";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "UspDeleteAllRoleDetail";
