...
{
	public class spSelectDISTRIBUTOR_USER_01
	{
		#region Private Members
		private string sp_Name = " spSelectDISTRIBUTOR_USER_01" ;
		...
		#region Constructor
		public spSelectDISTRIBUTOR_USER_01()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectDISTRIBUTOR_USER_01";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectDISTRIBUTOR_USER_01";
