...
{
	public class spUpdateDTCHEQUE_ENTRY
	{
		#region Private Members
		private string sp_Name = " spUpdateDTCHEQUE_ENTRY" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTCHEQUE_ENTRY";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTCHEQUE_ENTRY";
