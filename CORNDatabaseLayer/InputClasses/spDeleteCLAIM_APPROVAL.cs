...
{
	public class spDeleteCLAIM_APPROVAL
	{
		#region Private Members
		private string sp_Name = " spDeleteCLAIM_APPROVAL" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteCLAIM_APPROVAL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteCLAIM_APPROVAL";
