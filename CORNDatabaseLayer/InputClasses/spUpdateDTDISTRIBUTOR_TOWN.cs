...
{
	public class spUpdateDTDISTRIBUTOR_TOWN
	{
		#region Private Members
		private string sp_Name = " spUpdateDTDISTRIBUTOR_TOWN" ;
		...
		#region Constructor
		public spUpdateDTDISTRIBUTOR_TOWN()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTDISTRIBUTOR_TOWN";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTDISTRIBUTOR_TOWN";
...
////					m_TOWN_ID= Convert.ToInt32(first_row["TOWN_ID"]);
