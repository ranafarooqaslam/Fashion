...
{
	public class spDeleteDTSALE_ORDER_DETAIL
	{
		#region Private Members
		private string sp_Name = " spDeleteDTSALE_ORDER_DETAIL" ;
		...
		#region Constructor
		public spDeleteDTSALE_ORDER_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteDTSALE_ORDER_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteDTSALE_ORDER_DETAIL";
