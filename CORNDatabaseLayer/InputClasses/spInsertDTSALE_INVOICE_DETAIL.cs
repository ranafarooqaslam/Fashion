...
{
	public class spInsertDTSALE_INVOICE_DETAIL
	{
		#region Private Members
		private string sp_Name = " spInsertDTSALE_INVOICE_DETAIL" ;
		...
		#region Constructor
		public spInsertDTSALE_INVOICE_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTSALE_INVOICE_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTSALE_INVOICE_DETAIL";
