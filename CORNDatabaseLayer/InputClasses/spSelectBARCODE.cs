    ...
    public class spSelectBARCODE
    {
		...
		public void FirstReader(IDataReader dr)
		{
			if(dr.Read())
			{
                ...
                m_PRODUCT_NAME = Convert.ToInt32(dr["PRODUCT_NAME"]);
                m_PRODUCT_PRICE = Convert.ToDecimal(dr["PRODUCT_PRICE"]);
              //  m_BARCODE_IMAGE =Convert.ToByte(dr["BARCODE_IMAGE"]);
			}
		}
		public void GetParameterCollection(ref IDbCommand cmd)
		{
            ...
            //if (m_PRODUCT_PRICE == Constants.DecimalNullValue)
            //{
            //    parameter.Value = DBNull.Value;
            //}
            //else
