...
{
	public class uspSelectSync_LogID
	{
		#region Private Members
		private string sp_Name = " uspSelectSync_LogID" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectSync_LogID";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectSync_LogID";
