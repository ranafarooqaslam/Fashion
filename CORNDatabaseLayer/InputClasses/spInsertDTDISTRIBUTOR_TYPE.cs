...
{
	public class spInsertDTDISTRIBUTOR_TYPE
	{
		#region Private Members
		private string sp_Name = " spInsertDTDISTRIBUTOR_TYPE" ;
		...
		#region Constructor
		public spInsertDTDISTRIBUTOR_TYPE()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTDISTRIBUTOR_TYPE";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTDISTRIBUTOR_TYPE";
