...
{
	public class spSelectGEO_HIERARCHY
	{
		#region Private Members
		private string sp_Name = " spSelectGEO_HIERARCHY" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectGEO_HIERARCHY";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectGEO_HIERARCHY";
...
//			}
		    ...
		    public void GetParameterCollection(ref IDbCommand cmd)
		{
			...
			else if( m_ISDELETED == Constants.IntNullValue)
			{
			   parameter.Value = DBNull.Value;
			}
			pparams.Add(parameter);
