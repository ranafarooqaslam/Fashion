...
{
	public class spInsertDTDISTRIBUTOR_USER
	{
		#region Private Members
		private string sp_Name = " spInsertDTDISTRIBUTOR_USER" ;
		...
		#region Constructor
		public spInsertDTDISTRIBUTOR_USER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTDISTRIBUTOR_USER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTDISTRIBUTOR_USER";
