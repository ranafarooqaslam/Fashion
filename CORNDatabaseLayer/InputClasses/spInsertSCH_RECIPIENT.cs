...
{
	public class spInsertSCH_RECIPIENT
	{
		#region Private Members
		private string sp_Name = " spInsertSCH_RECIPIENT" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertSCH_RECIPIENT";
				...
				cmd.ExecuteNonQuery();
				m_SCH_RECIPIENT_ID = (int)((IDataParameter)(cmd.Parameters["@SCH_RECIPIENT_ID"])).Value;
				return true;
			}
			catch(Exception e)
			{
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertSCH_RECIPIENT";
