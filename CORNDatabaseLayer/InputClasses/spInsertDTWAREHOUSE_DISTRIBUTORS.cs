...
{
	public class spInsertDTWAREHOUSE_DISTRIBUTORS
	{
		#region Private Members
		private string sp_Name = " spInsertDTWAREHOUSE_DISTRIBUTORS" ;
		...
		#region Constructor
		public spInsertDTWAREHOUSE_DISTRIBUTORS()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTWAREHOUSE_DISTRIBUTORS";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTWAREHOUSE_DISTRIBUTORS";
