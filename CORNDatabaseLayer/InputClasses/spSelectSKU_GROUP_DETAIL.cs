...
{
	public class spSelectSKU_GROUP_DETAIL
	{
		#region Private Members
		private string sp_Name = " spSelectSKU_GROUP_DETAIL" ;
		...
		#region Constructor
		public spSelectSKU_GROUP_DETAIL()
		{
			m_SKU_GROUP_DETAIL_ID = Constants.IntNullValue;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectSKU_GROUP_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectSKU_GROUP_DETAIL";
...
//					m_SKU_GROUP_ID= Convert.ToInt32(first_row["SKU_GROUP_ID"]);
