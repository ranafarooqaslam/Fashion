...
{
	public class uspSelectPROMOTION_FOR_dt
	{
		#region Private Members
		private string sp_Name = " uspSelectPROMOTION_FOR_dt" ;
		...
		#region Constructor
		public uspSelectPROMOTION_FOR_dt()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectPROMOTION_FOR_dt";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectPROMOTION_FOR_dt";
