...
{
	public class spUpdateDTSALE_ORDER_PROMOTION
	{
		#region Private Members
		private string sp_Name = " spUpdateDTSALE_ORDER_PROMOTION" ;
		...
		#region Constructor
		public spUpdateDTSALE_ORDER_PROMOTION()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTSALE_ORDER_PROMOTION";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTSALE_ORDER_PROMOTION";
