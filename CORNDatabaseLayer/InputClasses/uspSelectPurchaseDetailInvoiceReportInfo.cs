...
{
	public class uspSelectPurchaseDetailInvoiceReportInfo
	{
		#region Private Members
		private string sp_Name = " uspSelectPurchaseDetailInvoiceReportInfo" ;
		...
		#region Constructor
		public uspSelectPurchaseDetailInvoiceReportInfo()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectPurchaseDetailInvoiceReportInfo";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectPurchaseDetailInvoiceReportInfo";
