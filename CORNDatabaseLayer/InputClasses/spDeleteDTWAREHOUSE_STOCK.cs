...
{
	public class spDeleteDTWAREHOUSE_STOCK
	{
		#region Private Members
		private string sp_Name = " spDeleteDTWAREHOUSE_STOCK" ;
		...
		#region Constructor
		public spDeleteDTWAREHOUSE_STOCK()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteDTWAREHOUSE_STOCK";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteDTWAREHOUSE_STOCK";
