...
{
	public class spUpdateDTCLAIM_DETAIL
	{
		#region Private Members
		private string sp_Name = " spUpdateDTCLAIM_DETAIL" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTCLAIM_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTCLAIM_DETAIL";
