...
{
	public class spUpdateDTMODULES
	{
		#region Private Members
		private string sp_Name = " spUpdateDTMODULES" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTMODULES";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTMODULES";
