...
{
	public class spUpdateDTSKU_GROUP
	{
		#region Private Members
		private string sp_Name = " spUpdateDTSKU_GROUP" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTSKU_GROUP";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTSKU_GROUP";
