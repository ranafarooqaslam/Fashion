...
{
	public class uspSelectDeliveryMan
	{
		#region Private Members
		private string sp_Name = " uspSelectDeliveryMan" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectDeliveryMan";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectDeliveryMan";
