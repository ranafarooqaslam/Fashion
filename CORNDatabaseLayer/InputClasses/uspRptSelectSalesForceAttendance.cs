...
{
	public class uspRptSelectSalesForceAttendance
	{
		#region Private Members
		private string sp_Name = " uspRptSelectSalesForceAttendance" ;
		...
		#region Constructor
		public uspRptSelectSalesForceAttendance()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspRptSelectSalesForceAttendance";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspRptSelectSalesForceAttendance";
