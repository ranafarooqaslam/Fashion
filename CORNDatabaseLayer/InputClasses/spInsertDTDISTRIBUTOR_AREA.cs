...
{
	public class spInsertDTDISTRIBUTOR_AREA
	{
		#region Private Members
		private string sp_Name = " spInsertDTDISTRIBUTOR_AREA" ;
		...
		#region Constructor
		public spInsertDTDISTRIBUTOR_AREA()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTDISTRIBUTOR_AREA";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTDISTRIBUTOR_AREA";
