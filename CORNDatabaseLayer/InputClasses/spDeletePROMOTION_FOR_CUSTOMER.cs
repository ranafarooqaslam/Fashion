...
{
	public class spDeletePROMOTION_FOR_CUSTOMER
	{
		#region Private Members
		private string sp_Name = " spDeletePROMOTION_FOR_CUSTOMER" ;
		...
		#region Constructor
		public spDeletePROMOTION_FOR_CUSTOMER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeletePROMOTION_FOR_CUSTOMER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeletePROMOTION_FOR_CUSTOMER";
