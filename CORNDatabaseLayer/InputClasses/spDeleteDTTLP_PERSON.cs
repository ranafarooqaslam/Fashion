...
{
	public class spDeleteDTTLP_PERSON
	{
		#region Private Members
		private string sp_Name = " spDeleteDTTLP_PERSON" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteDTTLP_PERSON";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteDTTLP_PERSON";
