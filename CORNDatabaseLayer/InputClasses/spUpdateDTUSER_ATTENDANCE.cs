...
{
	public class spUpdateDTUSER_ATTENDANCE
	{
		#region Private Members
		private string sp_Name = " spUpdateDTUSER_ATTENDANCE" ;
		...
		#region Constructor
		public spUpdateDTUSER_ATTENDANCE()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTUSER_ATTENDANCE";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTUSER_ATTENDANCE";
