...
{
	public class spSelectSKU_MAPPING
	{
		#region Private Members
		private string sp_Name = " spSelectSKU_MAPPING" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectSKU_MAPPING";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectSKU_MAPPING";
