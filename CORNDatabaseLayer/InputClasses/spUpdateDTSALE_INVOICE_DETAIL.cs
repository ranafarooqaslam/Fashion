...
{
	public class spUpdateDTSALE_INVOICE_DETAIL
	{
		#region Private Members
		private string sp_Name = " spUpdateDTSALE_INVOICE_DETAIL" ;
		...
		#region Constructor
		public spUpdateDTSALE_INVOICE_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTSALE_INVOICE_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTSALE_INVOICE_DETAIL";
