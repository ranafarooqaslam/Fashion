...
{
	public class spSelectHHSaleOrder
	{
		#region Private Members
		private string sp_Name = " spSelectHHSaleOrder" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectHHSaleOrder";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectHHSaleOrder";
