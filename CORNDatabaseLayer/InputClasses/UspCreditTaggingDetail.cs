...
{
	public class UspCreditTaggingDetail
	{
		#region Private Members
		private string sp_Name = " UspCreditTaggingDetail" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "UspCreditTaggingDetail";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "UspCreditTaggingDetail";
