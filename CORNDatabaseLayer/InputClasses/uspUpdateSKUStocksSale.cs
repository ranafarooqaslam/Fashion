...
{
	public class uspUpdateSKUStocksSale
	{
		#region Private Members
		private string sp_Name = " uspUpdateSKUStocksSale" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspUpdateSKUStocksSale";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspUpdateSKUStocksSale";
