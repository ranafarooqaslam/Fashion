...
{
	public class spSelectCLAIM_MASTER
	{
		#region Private Members
		private string sp_Name = " spSelectCLAIM_MASTER" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectCLAIM_MASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectCLAIM_MASTER";
