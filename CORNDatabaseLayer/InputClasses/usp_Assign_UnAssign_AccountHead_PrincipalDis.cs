...
{
	public class usp_Assign_UnAssign_AccountHead_PrincipalDis
	{
		#region Private Members
		private string sp_Name = "usp_Assign_UnAssign_AccountHead_PrincipalDis" ;
		...
		#endregion
		#region Constructor
		public usp_Assign_UnAssign_AccountHead_PrincipalDis()
		{
		}
		#endregion
