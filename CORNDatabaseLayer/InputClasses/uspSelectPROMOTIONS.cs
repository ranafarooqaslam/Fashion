...
{
	public class uspSelectPROMOTIONS
	{
		#region Private Members
		private string sp_Name = " uspSelectPROMOTIONS" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectPROMOTIONS";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectPROMOTIONS";
