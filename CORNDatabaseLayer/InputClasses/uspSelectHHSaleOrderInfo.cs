...
{
	public class uspSelectHHSaleOrderInfo
	{
		#region Private Members
		private string sp_Name = " uspSelectHHSaleOrderInfo" ;
		...
		#region Constructor
		public uspSelectHHSaleOrderInfo()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectHHSaleOrderInfo";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectHHSaleOrderInfo";
