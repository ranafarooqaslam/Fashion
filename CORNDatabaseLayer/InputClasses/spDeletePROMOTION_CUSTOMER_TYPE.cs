...
{
	public class spDeletePROMOTION_CUSTOMER_TYPE
	{
		#region Private Members
		private string sp_Name = " spDeletePROMOTION_CUSTOMER_TYPE" ;
		...
		#region Constructor
		public spDeletePROMOTION_CUSTOMER_TYPE()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeletePROMOTION_CUSTOMER_TYPE";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeletePROMOTION_CUSTOMER_TYPE";
