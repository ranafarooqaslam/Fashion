...
{
	public class uspSelectSALE_INVOICE_DETAIL_ById
	{
		#region Private Members
		private string sp_Name = " uspSelectSALE_INVOICE_DETAIL_ById" ;
		...
		#region Constructor
		public uspSelectSALE_INVOICE_DETAIL_ById()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectSALE_INVOICE_DETAIL_ById";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectSALE_INVOICE_DETAIL_ById";
