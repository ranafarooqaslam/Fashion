...
{
	public class spInsertSLASH_USER
	{
		#region Private Members
		private string sp_Name = " spInsertSLASH_USER" ;
		...
		private bool m_IS_SERVER_LOGIN;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertSLASH_USER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertSLASH_USER";
		...
		public string ExecuteScalar()
		{
			...
			public void FirstReader(IDataReader dr)
			{
				if(dr.Read())
				{
					...
					m_IS_SERVER_LOGIN=Convert.ToBoolean(dr["IS_SERVER_LOGIN"]);
		    ...
		    public void GetParameterCollection(ref IDbCommand cmd)
		{
			...
			parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.Bit);
				parameter.Value = m_IS_SERVER_LOGIN;
			pparams.Add(parameter);
