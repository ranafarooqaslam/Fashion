...
{
	public class spUpdateDTMerchandizing_Items
	{
		#region Private Members
		private string sp_Name = " spUpdateDTMerchandizing_Items" ;
		...
		#region Constructor
		public spUpdateDTMerchandizing_Items()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTMerchandizing_Items";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTMerchandizing_Items";
