...
{
	public class spSelectSCH_PARAMETER
	{
		#region Private Members
		private string sp_Name = " spSelectSCH_PARAMETER" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectSCH_PARAMETER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectSCH_PARAMETER";
