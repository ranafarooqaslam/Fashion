...
{
	public class spUpdateDTDISTRIBUTOR_ROUTE
	{
		#region Private Members
		private string sp_Name = " spUpdateDTDISTRIBUTOR_ROUTE" ;
		...
		#region Constructor
		public spUpdateDTDISTRIBUTOR_ROUTE()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTDISTRIBUTOR_ROUTE";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTDISTRIBUTOR_ROUTE";
