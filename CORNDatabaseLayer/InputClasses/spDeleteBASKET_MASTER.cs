...
{
	public class spDeleteBASKET_MASTER
	{
		#region Private Members
		private string sp_Name = " spDeleteBASKET_MASTER" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteBASKET_MASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteBASKET_MASTER";
