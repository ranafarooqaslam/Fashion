...
{
	public class spUpdateSALES_FORCE_AREA_ASSIGNMENT
	{
		#region Private Members
		private string sp_Name = " spUpdateSALES_FORCE_AREA_ASSIGNMENT" ;
		...
		#region Constructor
		public spUpdateSALES_FORCE_AREA_ASSIGNMENT()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateSALES_FORCE_AREA_ASSIGNMENT";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateSALES_FORCE_AREA_ASSIGNMENT";
