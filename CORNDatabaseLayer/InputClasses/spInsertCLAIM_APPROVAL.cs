...
{
	public class spInsertCLAIM_APPROVAL
	{
		#region Private Members
		private string sp_Name = " spInsertCLAIM_APPROVAL" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertCLAIM_APPROVAL";
				...
				cmd.ExecuteNonQuery();
				m_CLAIM_APPROVAL_ID = (long)((IDataParameter)(cmd.Parameters["@CLAIM_APPROVAL_ID"])).Value;
				return true;
			}
			catch(Exception e)
			{
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertCLAIM_APPROVAL";
