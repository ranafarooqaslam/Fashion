...
{
	public class spPROCESS_PROMOTION
	{
		#region Private Members
		private string sp_Name = " spPROCESS_PROMOTION" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spPROCESS_PROMOTION";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spPROCESS_PROMOTION";
