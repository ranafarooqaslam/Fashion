...
{
	public class uspSelectSALE_ORDER_MASTER_dt
	{
		#region Private Members
		private string sp_Name = " uspSelectSALE_ORDER_MASTER_dt" ;
		...
		private char m_TOTAL_CLAIM_AMOUNT;
		...
		public char TOTAL_CLAIM_AMOUNT
		{
			set
			{
		...
		#region Constructor
		public uspSelectSALE_ORDER_MASTER_dt()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectSALE_ORDER_MASTER_dt";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectSALE_ORDER_MASTER_dt";
		...
		public string ExecuteScalar()
		{
			...
			public void FirstReader(IDataReader dr)
			{
				if(dr.Read())
				{
					...
					m_TOTAL_CLAIM_AMOUNT= Convert.ToChar(dr["TOTAL_CLAIM_AMOUNT"]);
		    ...
		    public void GetParameterCollection(ref IDbCommand cmd)
		{
			...
			if(m_TOTAL_CLAIM_AMOUNT==Constants.CharNullValue )
			{
				parameter.Value = DBNull.Value;
			}
			else
