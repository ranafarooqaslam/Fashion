...
{
	public class spInsertDTDISTRIBUTOR_SKU
	{
		#region Private Members
		private string sp_Name = " spInsertDTDISTRIBUTOR_SKU" ;
		...
		#region Constructor
		public spInsertDTDISTRIBUTOR_SKU()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTDISTRIBUTOR_SKU";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTDISTRIBUTOR_SKU";
		...
		public void FirstReader(IDataReader dr)
		{
			if(dr.Read())
			{
				...
				m_MIN_STOCK_LEVEL= Convert.ToInt32(dr["MIN_STOCK_LEVEL"]);
			}
		}
