...
{
	public class spInsertDTSALE_INVOICE_MASTER
	{
		#region Private Members
		private string sp_Name = " spInsertDTSALE_INVOICE_MASTER" ;
		...
		#region Constructor
		public spInsertDTSALE_INVOICE_MASTER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTSALE_INVOICE_MASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTSALE_INVOICE_MASTER";
