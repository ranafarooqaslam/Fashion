...
{
	public class spInsertDISTRIBUTOR_AREA
	{
		#region Private Members
		private string sp_Name = " spInsertDISTRIBUTOR_AREA" ;
		...
		#region Constructor
		public spInsertDISTRIBUTOR_AREA()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDISTRIBUTOR_AREA";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDISTRIBUTOR_AREA";
