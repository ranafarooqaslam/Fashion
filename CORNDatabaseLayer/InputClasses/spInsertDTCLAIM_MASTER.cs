...
{
	public class spInsertDTCLAIM_MASTER
	{
		#region Private Members
		private string sp_Name = " spInsertDTCLAIM_MASTER" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTCLAIM_MASTER";
				...
				cmd.ExecuteNonQuery();
				//m_CLAIM_ID = (long)((IDataParameter)(cmd.Parameters["@CLAIM_ID"])).Value;
				return true;
			}
			catch(Exception e)
			{
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTCLAIM_MASTER";
