...
{
	public class uspSelectSALE_ORDER_PROMOTION_dt
	{
		#region Private Members
		private string sp_Name = " uspSelectSALE_ORDER_PROMOTION_dt" ;
		private IDbConnection m_connection;
		private IDbTransaction m_transaction;


		private long m_SALE_ORDER_DETAIL_ID;
		private float  m_GST_RATE=Constants.FloatNullValue;
		private int m_BASKET_DETAIL_ID = Constants.IntNullValue;
		private int m_SKU_ID = Constants.IntNullValue;
		private int m_QUANTITY = Constants.IntNullValue;
		private int m_BASKET_ID = Constants.IntNullValue;
		private int m_PROMOTION_ID = Constants.IntNullValue;
		private int m_SCHEME_ID = Constants.IntNullValue;
		private int m_SALE_ORDER_PROMOTION_ID = Constants.IntNullValue;
		private int m_DISTRIBUTOR_ID = Constants.IntNullValue;
		private int m_PROMOTION_OFFER_ID = Constants.IntNullValue;
		private decimal m_CLAIM_AMOUNT = Constants.DecimalNullValue;
		private decimal m_UNIT_PRICE = Constants.DecimalNullValue;
		private decimal m_RETAIL_PRICE = Constants.DecimalNullValue;
		private decimal m_GST_AMOUNT = Constants.DecimalNullValue;
		#endregion
		...
		#region Constructor
		public uspSelectSALE_ORDER_PROMOTION_dt()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectSALE_ORDER_PROMOTION_dt";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectSALE_ORDER_PROMOTION_dt";
