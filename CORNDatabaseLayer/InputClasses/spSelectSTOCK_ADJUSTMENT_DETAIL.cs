...
{
	public class spSelectSTOCK_ADJUSTMENT_DETAIL
	{
		#region Private Members
		private string sp_Name = " spSelectSTOCK_ADJUSTMENT_DETAIL" ;
		...
		#region Constructor
		public spSelectSTOCK_ADJUSTMENT_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectSTOCK_ADJUSTMENT_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectSTOCK_ADJUSTMENT_DETAIL";
