...
{
	public class spPROCESS_SCHEME
	{
		#region Private Members
		private string sp_Name = " spPROCESS_SCHEME" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spPROCESS_SCHEME";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spPROCESS_SCHEME";
