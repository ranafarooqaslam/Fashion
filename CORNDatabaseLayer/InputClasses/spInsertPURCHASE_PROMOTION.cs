...
{
	public class spInsertPURCHASE_PROMOTION
	{
		#region Private Members
		private string sp_Name = " spInsertPURCHASE_PROMOTION" ;
		...
		#region Constructor
		public spInsertPURCHASE_PROMOTION()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertPURCHASE_PROMOTION";
				...
				cmd.ExecuteNonQuery();
				m_PURCHASE_PROMOTION_ID = (int)((IDataParameter)(cmd.Parameters["@PURCHASE_PROMOTION_ID"])).Value;
				return true;
			}
			catch(Exception e)
			{
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertPURCHASE_PROMOTION";
