...
{
	public class spDeleteDTGIFT_REQUEST
	{
		#region Private Members
		private string sp_Name = " spDeleteDTGIFT_REQUEST" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteDTGIFT_REQUEST";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteDTGIFT_REQUEST";
