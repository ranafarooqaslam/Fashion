...
{
	public class spDeleteSALE_ORDER_PROMOTION
	{
		#region Private Members
		private string sp_Name = " spDeleteSALE_ORDER_PROMOTION" ;
		...
		#region Constructor
		public spDeleteSALE_ORDER_PROMOTION()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteSALE_ORDER_PROMOTION";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteSALE_ORDER_PROMOTION";
