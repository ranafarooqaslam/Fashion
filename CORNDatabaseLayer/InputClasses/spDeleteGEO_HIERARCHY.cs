...
{
	public class spDeleteGEO_HIERARCHY
	{
		#region Private Members
		private string sp_Name = " spDeleteGEO_HIERARCHY" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteGEO_HIERARCHY";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteGEO_HIERARCHY";
