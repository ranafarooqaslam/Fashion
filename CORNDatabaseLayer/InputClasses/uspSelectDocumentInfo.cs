...
{
	public class uspSelectDocumentInfo
	{
		#region Private Members
		private string sp_Name = " uspSelectDocumentInfo" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectDocumentInfo";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectDocumentInfo";
