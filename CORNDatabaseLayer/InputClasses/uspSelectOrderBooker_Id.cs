...
{
	public class uspSelectOrderBooker_Id
	{
		#region Private Members
		private string sp_Name = " uspSelectOrderBooker_Id" ;
		...
		#region Constructor
		public uspSelectOrderBooker_Id()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectOrderBooker_Id";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectOrderBooker_Id";
