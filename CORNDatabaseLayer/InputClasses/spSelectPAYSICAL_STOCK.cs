...
namespace CORNDatabaseLayer.Classes
{
	public class spSelectPAYSICAL_STOCK
	{
        ...
        public long Physical_Stock_ID { get; set; }
        ...
        public DataTable ExecuteTableForMaxDocNo()
        {
            try
            {
                IDbCommand command = ProviderFactory.GetCommand(EnumProviders.SQLClient);
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = "spSelectMaxDocNO_PAYSICAL_STOCK";
                command.Connection = m_connection;
                if (m_transaction != null)
                {
                    command.Transaction = m_transaction;
		    ...
		    public void GetParameterCollection(ref IDbCommand cmd)
		{
            ...
            parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
            parameter.ParameterName = "@Physical_Stock_ID";
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.BigInt);
            if (Physical_Stock_ID == Constants.LongNullValue)
            {
                parameter.Value = DBNull.Value;
            }
            else
            {
                parameter.Value = Physical_Stock_ID;
            }
            pparams.Add(parameter);
        }
		#endregion
