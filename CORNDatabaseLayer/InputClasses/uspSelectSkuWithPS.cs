...
{
	public class uspSelectSkuWithPS
	{
		#region Private Members
		private string sp_Name = "uspSelectSkuWithPS" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectSkuWithPS";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectSkuWithPS";
