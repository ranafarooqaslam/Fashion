...
{
	public class spUpdateDISTRIBUTOR_ROUTE
	{
		#region Private Members
		private string sp_Name = " spUpdateDISTRIBUTOR_ROUTE" ;
		...
		#region Constructor
		public spUpdateDISTRIBUTOR_ROUTE()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDISTRIBUTOR_ROUTE";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDISTRIBUTOR_ROUTE";
