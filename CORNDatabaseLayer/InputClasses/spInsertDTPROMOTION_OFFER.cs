...
{
	public class spInsertDTPROMOTION_OFFER
	{
		#region Private Members
		private string sp_Name = " spInsertDTPROMOTION_OFFER" ;
		...
		#region Constructor
		public spInsertDTPROMOTION_OFFER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTPROMOTION_OFFER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTPROMOTION_OFFER";
