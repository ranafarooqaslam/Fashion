...
{
    public class UspDeleteVendorDetail
    {
         #region Private Members
        private string sp_Name = "UspDeleteVendorDetail";
        ...
        private int m_MANUAL_DOCUMENT_NO;
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "UspDeleteVendorDetail";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "UspDeleteVendorDetail";
        ...
        public void GetParameterCollection(ref IDbCommand cmd)
        {
            ...
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.Int);
            if (m_MANUAL_DOCUMENT_NO == Constants.IntNullValue)
            {
                parameter.Value = DBNull.Value;
            }
            else
