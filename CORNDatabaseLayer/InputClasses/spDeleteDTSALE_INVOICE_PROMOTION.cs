...
{
	public class spDeleteDTSALE_INVOICE_PROMOTION
	{
		#region Private Members
		private string sp_Name = " spDeleteDTSALE_INVOICE_PROMOTION" ;
		...
		#region Constructor
		public spDeleteDTSALE_INVOICE_PROMOTION()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteDTSALE_INVOICE_PROMOTION";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteDTSALE_INVOICE_PROMOTION";
