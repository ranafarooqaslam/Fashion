...
{
	public class spDeleteDTCUSTOMER_TLP_PERSON
	{
		#region Private Members
		private string sp_Name = " spDeleteDTCUSTOMER_TLP_PERSON" ;
		...
		#region Constructor
		public spDeleteDTCUSTOMER_TLP_PERSON()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteDTCUSTOMER_TLP_PERSON";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteDTCUSTOMER_TLP_PERSON";
