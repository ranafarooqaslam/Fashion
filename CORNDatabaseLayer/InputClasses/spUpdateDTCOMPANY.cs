...
{
	public class spUpdateDTCOMPANY
	{
		#region Private Members
		private string sp_Name = " spUpdateDTCOMPANY" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTCOMPANY";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTCOMPANY";
