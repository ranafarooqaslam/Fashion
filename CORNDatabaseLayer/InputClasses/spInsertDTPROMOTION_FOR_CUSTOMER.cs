...
{
	public class spInsertDTPROMOTION_FOR_CUSTOMER
	{
		#region Private Members
		private string sp_Name = " spInsertDTPROMOTION_FOR_CUSTOMER" ;
		...
		#region Constructor
		public spInsertDTPROMOTION_FOR_CUSTOMER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTPROMOTION_FOR_CUSTOMER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTPROMOTION_FOR_CUSTOMER";
