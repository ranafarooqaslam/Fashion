...
{
	public class spUpdateDTPROMOTION_CUSTOMER_TYPE
	{
		#region Private Members
		private string sp_Name = " spUpdateDTPROMOTION_CUSTOMER_TYPE" ;
		...
		#region Constructor
		public spUpdateDTPROMOTION_CUSTOMER_TYPE()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTPROMOTION_CUSTOMER_TYPE";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTPROMOTION_CUSTOMER_TYPE";
