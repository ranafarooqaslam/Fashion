...
{
	public class spInsertSALEFORCE_PRINCIPAL_ASSIGNMENT
	{
		#region Private Members
		private string sp_Name = " spInsertSALEFORCE_PRINCIPAL_ASSIGNMENT" ;
		...
		#region Constructor
		public spInsertSALEFORCE_PRINCIPAL_ASSIGNMENT()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertSALEFORCE_PRINCIPAL_ASSIGNMENT";
				...
				cmd.ExecuteNonQuery();
				m_SALEFORCE_PRINCIPAL_ASSIGNMENT_ID = (long)((IDataParameter)(cmd.Parameters["@SALEFORCE_PRINCIPAL_ASSIGNMENT_ID"])).Value;
				return true;
			}
			catch(Exception e)
			{
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertSALEFORCE_PRINCIPAL_ASSIGNMENT";
