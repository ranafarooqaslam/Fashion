...
{
	public class spSelectSCHEDULE
	{
		#region Private Members
		private string sp_Name = " spSelectSCHEDULE" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectSCHEDULE";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectSCHEDULE";
