...
{
	public class UspSelectTranspoterInvoice
	{
        #region Private Members
        private string sp_Name = " UspSelectTranspoterInvoice";
        ...
        #region Constructor
        public UspSelectTranspoterInvoice()
        {
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "UspSelectTranspoterInvoice";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "UspSelectTranspoterInvoice";
