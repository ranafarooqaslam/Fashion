...
{
	public class spSelectHHSaleOrderPromotion
	{
		#region Private Members
		private string sp_Name = " spSelectHHSaleOrderPromotion" ;
		...
		#region Constructor
		public spSelectHHSaleOrderPromotion()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectHHSaleOrderPromotion";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectHHSaleOrderPromotion";
