...
{
	public class spInsertDTLOYALTYPOINT_DISTRIBUTOR
	{
		#region Private Members
		private string sp_Name = " spInsertDTLOYALTYPOINT_DISTRIBUTOR" ;
		...
		#region Constructor
		public spInsertDTLOYALTYPOINT_DISTRIBUTOR()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTLOYALTYPOINT_DISTRIBUTOR";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTLOYALTYPOINT_DISTRIBUTOR";
