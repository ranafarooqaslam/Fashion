...
{
	public class spInsertDTSKU_STOCK_REGISTER
	{
		#region Private Members
		private string sp_Name = " spInsertDTSKU_STOCK_REGISTER" ;
		...
		#region Constructor
		public spInsertDTSKU_STOCK_REGISTER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTSKU_STOCK_REGISTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTSKU_STOCK_REGISTER";
