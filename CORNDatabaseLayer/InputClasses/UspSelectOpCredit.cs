...
{
    public class UspSelectOpCredit
    {
        #region Private Members
        private string sp_Name = " UspSelectOpCredit";
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "UspSelectOpCredit";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "UspSelectOpCredit";
