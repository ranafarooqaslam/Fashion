...
{
	public class spUpdateDTTARGET
	{
		#region Private Members
		private string sp_Name = " spUpdateDTTARGET" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTTARGET";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTTARGET";
