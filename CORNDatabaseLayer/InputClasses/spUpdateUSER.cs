...
namespace CORNDatabaseLayer.Classes
{
	public class spUpdateUSER
	{
        ...
        private bool m_DISCOUNT_ALLOWD;
        ...
        public bool DISCOUNT_ALLOWD
        {
            set
            {
                m_DISCOUNT_ALLOWD = value;
            }
            get
            {
                return m_DISCOUNT_ALLOWD;
            }
        }
        ...
        public void FirstReader(IDataReader dr)
        {
            if (dr.Read())
            {
                ...
                m_DISCOUNT_ALLOWD = Convert.ToBoolean(dr["DISCOUNT_ALLOWD"]);
            }
        }
        ...
        public void GetParameterCollection(ref IDbCommand cmd)
        {
            ...
            parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
            parameter.ParameterName = "@DISCOUNT_ALLOWD";
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.Bit);
            parameter.Value = m_DISCOUNT_ALLOWD;
            pparams.Add(parameter);
