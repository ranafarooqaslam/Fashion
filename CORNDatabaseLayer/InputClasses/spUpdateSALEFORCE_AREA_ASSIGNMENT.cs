...
{
	public class spUpdateSALEFORCE_AREA_ASSIGNMENT
	{
		#region Private Members
		private string sp_Name = " spUpdateSALEFORCE_AREA_ASSIGNMENT" ;
		...
		#region Constructor
		public spUpdateSALEFORCE_AREA_ASSIGNMENT()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateSALEFORCE_AREA_ASSIGNMENT";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateSALEFORCE_AREA_ASSIGNMENT";
