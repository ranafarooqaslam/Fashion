...
{
	public class uspSumAmountPickSlipEntries
	{
		#region Private Members
		private string sp_Name = " uspSumAmountPickSlipEntries" ;
		...
		#region Constructor
		public uspSumAmountPickSlipEntries()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSumAmountPickSlipEntries";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSumAmountPickSlipEntries";
