...
{
	public class spUpdateDTSKU_TAX
	{
		#region Private Members
		private string sp_Name = " spUpdateDTSKU_TAX" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTSKU_TAX";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTSKU_TAX";
