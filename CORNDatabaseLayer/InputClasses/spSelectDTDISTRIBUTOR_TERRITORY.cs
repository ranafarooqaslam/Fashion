...
{
	public class spSelectDTDISTRIBUTOR_TERRITORY
	{
		#region Private Members
		private string sp_Name = " spSelectDTDISTRIBUTOR_TERRITORY" ;
		...
		#region Constructor
		public spSelectDTDISTRIBUTOR_TERRITORY()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectDTDISTRIBUTOR_TERRITORY";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectDTDISTRIBUTOR_TERRITORY";
