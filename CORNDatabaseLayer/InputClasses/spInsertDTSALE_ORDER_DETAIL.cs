...
{
	public class spInsertDTSALE_ORDER_DETAIL
	{
		#region Private Members
		private string sp_Name = " spInsertDTSALE_ORDER_DETAIL" ;
		...
		#region Constructor
		public spInsertDTSALE_ORDER_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTSALE_ORDER_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTSALE_ORDER_DETAIL";
