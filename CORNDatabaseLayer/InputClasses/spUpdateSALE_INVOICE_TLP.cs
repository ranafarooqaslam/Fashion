...
{
	public class spUpdateSALE_INVOICE_TLP
	{
		#region Private Members
		private string sp_Name = " spUpdateSALE_INVOICE_TLP" ;
		...
		#region Constructor
		public spUpdateSALE_INVOICE_TLP()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateSALE_INVOICE_TLP";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateSALE_INVOICE_TLP";
