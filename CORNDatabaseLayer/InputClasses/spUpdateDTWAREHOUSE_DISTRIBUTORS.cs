...
{
	public class spUpdateDTWAREHOUSE_DISTRIBUTORS
	{
		#region Private Members
		private string sp_Name = " spUpdateDTWAREHOUSE_DISTRIBUTORS" ;
		...
		#region Constructor
		public spUpdateDTWAREHOUSE_DISTRIBUTORS()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTWAREHOUSE_DISTRIBUTORS";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTWAREHOUSE_DISTRIBUTORS";
