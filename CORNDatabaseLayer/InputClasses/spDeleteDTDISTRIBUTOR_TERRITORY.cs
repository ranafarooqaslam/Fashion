...
{
	public class spDeleteDTDISTRIBUTOR_TERRITORY
	{
		#region Private Members
		private string sp_Name = " spDeleteDTDISTRIBUTOR_TERRITORY" ;
		...
		#region Constructor
		public spDeleteDTDISTRIBUTOR_TERRITORY()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteDTDISTRIBUTOR_TERRITORY";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteDTDISTRIBUTOR_TERRITORY";
