...
{
	public class UspSelectLedgerDetail
	{
		#region Private Members
		private string sp_Name = " UspSelectLedgerDetail" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "UspSelectLedgerDetail";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "UspSelectLedgerDetail";
