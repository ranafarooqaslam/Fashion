...
{
	public class spInsertPROMOTION_FOR_CUSTOMER
	{
		#region Private Members
		private string sp_Name = " spInsertPROMOTION_FOR_CUSTOMER" ;
		...
		#region Constructor
		public spInsertPROMOTION_FOR_CUSTOMER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertPROMOTION_FOR_CUSTOMER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertPROMOTION_FOR_CUSTOMER";
