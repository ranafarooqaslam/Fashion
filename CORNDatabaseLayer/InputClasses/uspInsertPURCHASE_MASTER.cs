...
{
	public class uspInsertPURCHASE_MASTER
	{
		#region Private Members
		private string sp_Name = " uspInsertPURCHASE_MASTER" ;
		...
		#region Constructor
		public uspInsertPURCHASE_MASTER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspInsertPURCHASE_MASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspInsertPURCHASE_MASTER";
