...
{
	public class spSelectDTSKU_HIERARCHY
	{
		#region Private Members
		private string sp_Name = " spSelectDTSKU_HIERARCHY" ;
		...
		private int m_SKU_HIE_ID = Constants.IntNullValue;
		private int m_PARENT_SKU_HIE_ID = Constants.IntNullValue;
		private int m_SKU_HIE_TYPE_ID = Constants.IntNullValue;
		private string m_SKU_HIE_CODE = null;
		private string m_SKU_HIE_NAME = null;
		...
		#region Constructor
		public spSelectDTSKU_HIERARCHY()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectDTSKU_HIERARCHY";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectDTSKU_HIERARCHY";
...
//					m_SKU_HIE_ID= Convert.ToInt32(first_row["SKU_HIE_ID"]);
//					m_PARENT_SKU_HIE_ID= Convert.ToInt32(first_row["PARENT_SKU_HIE_ID"]);
//					m_SKU_HIE_TYPE_ID= Convert.ToInt32(first_row["SKU_HIE_TYPE_ID"]);
//					m_SKU_HIE_CODE= Convert.ToString(first_row["SKU_HIE_CODE"]);
//					m_SKU_HIE_NAME= Convert.ToString(first_row["SKU_HIE_NAME"]);
