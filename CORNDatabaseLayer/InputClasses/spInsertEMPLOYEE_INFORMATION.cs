...
{
    public class spInsertEMPLOYEE_INFORMATION
    {
        #region Private Members
        private string sp_Name = " spInsertEMPLOYEE_INFORMATION";
        ...
        #region Constructor
        public spInsertEMPLOYEE_INFORMATION()
        {
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "spInsertEMPLOYEE_INFORMATION";
                ...
                cmd.ExecuteNonQuery();
                m_EMPLOYEE_ID = (int)((IDataParameter)(cmd.Parameters["@EMPLOYEE_ID"])).Value;
                return true;
            }
            catch (Exception e)
            {
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "spInsertEMPLOYEE_INFORMATION";
