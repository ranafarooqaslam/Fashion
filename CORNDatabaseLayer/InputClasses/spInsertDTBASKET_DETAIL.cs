...
{
	public class spInsertDTBASKET_DETAIL
	{
		#region Private Members
		private string sp_Name = " spInsertDTBASKET_DETAIL" ;
		...
		#region Constructor
		public spInsertDTBASKET_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTBASKET_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTBASKET_DETAIL";
