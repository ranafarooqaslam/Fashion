...
{
	public class spUpdateDTSALES_RETURN_MASTER
	{
		#region Private Members
		private string sp_Name = " spUpdateDTSALES_RETURN_MASTER" ;
		...
		#region Constructor
		public spUpdateDTSALES_RETURN_MASTER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTSALES_RETURN_MASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTSALES_RETURN_MASTER";
