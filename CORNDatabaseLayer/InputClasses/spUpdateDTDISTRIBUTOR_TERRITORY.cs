...
{
	public class spUpdateDTDISTRIBUTOR_TERRITORY
	{
		#region Private Members
		private string sp_Name = " spUpdateDTDISTRIBUTOR_TERRITORY" ;
		...
		#region Constructor
		public spUpdateDTDISTRIBUTOR_TERRITORY()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTDISTRIBUTOR_TERRITORY";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTDISTRIBUTOR_TERRITORY";
