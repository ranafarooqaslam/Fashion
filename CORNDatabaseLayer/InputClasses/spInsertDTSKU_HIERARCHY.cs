...
{
	public class spInsertDTSKU_HIERARCHY
	{
		#region Private Members
		private string sp_Name = " spInsertDTSKU_HIERARCHY" ;
		...
		#region Constructor
		public spInsertDTSKU_HIERARCHY()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTSKU_HIERARCHY";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTSKU_HIERARCHY";
