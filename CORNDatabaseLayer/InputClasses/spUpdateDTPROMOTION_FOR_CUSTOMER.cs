...
{
	public class spUpdateDTPROMOTION_FOR_CUSTOMER
	{
		#region Private Members
		private string sp_Name = " spUpdateDTPROMOTION_FOR_CUSTOMER" ;
		...
		#region Constructor
		public spUpdateDTPROMOTION_FOR_CUSTOMER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTPROMOTION_FOR_CUSTOMER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTPROMOTION_FOR_CUSTOMER";
