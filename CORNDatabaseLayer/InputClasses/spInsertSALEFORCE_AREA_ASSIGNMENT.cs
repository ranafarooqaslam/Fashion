...
{
	public class spInsertSALEFORCE_AREA_ASSIGNMENT
	{
		#region Private Members
		private string sp_Name = " spInsertSALEFORCE_AREA_ASSIGNMENT" ;
		...
		#region Constructor
		public spInsertSALEFORCE_AREA_ASSIGNMENT()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertSALEFORCE_AREA_ASSIGNMENT";
				...
				cmd.ExecuteNonQuery();
				m_AREA_ASSIGNMENT_ID = (long)((IDataParameter)(cmd.Parameters["@AREA_ASSIGNMENT_ID"])).Value;
				return true;
			}
			catch(Exception e)
			{
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertSALEFORCE_AREA_ASSIGNMENT";
