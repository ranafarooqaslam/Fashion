...
{
	public class spInsertDTSALE_INVOICE_PROMOTION
	{
		#region Private Members
		private string sp_Name = " spInsertDTSALE_INVOICE_PROMOTION" ;
		...
		#region Constructor
		public spInsertDTSALE_INVOICE_PROMOTION()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTSALE_INVOICE_PROMOTION";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTSALE_INVOICE_PROMOTION";
