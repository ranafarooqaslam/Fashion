...
{
    public class UspSelectCustomerBalance
    {
        #region Private Members
        private string sp_Name = " UspSelectCustomerBalance";
        ...
        #region Constructor
        public UspSelectCustomerBalance()
        {
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "UspSelectCustomerBalance";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "UspSelectCustomerBalance";
