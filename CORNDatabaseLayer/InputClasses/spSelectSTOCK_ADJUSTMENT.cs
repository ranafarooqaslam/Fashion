...
{
	public class spSelectSTOCK_ADJUSTMENT
	{
		#region Private Members
		private string sp_Name = " spSelectSTOCK_ADJUSTMENT" ;
		...
		#region Constructor
		public spSelectSTOCK_ADJUSTMENT()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectSTOCK_ADJUSTMENT";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectSTOCK_ADJUSTMENT";
