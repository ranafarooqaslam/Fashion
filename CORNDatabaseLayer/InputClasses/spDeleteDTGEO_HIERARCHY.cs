...
{
	public class spDeleteDTGEO_HIERARCHY
	{
		#region Private Members
		private string sp_Name = " spDeleteDTGEO_HIERARCHY" ;
		...
		#region Constructor
		public spDeleteDTGEO_HIERARCHY()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteDTGEO_HIERARCHY";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteDTGEO_HIERARCHY";
