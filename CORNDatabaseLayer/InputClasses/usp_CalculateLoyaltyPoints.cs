...
{
	public class usp_CalculateLoyaltyPoints
	{
		#region Private Members
		private string sp_Name = " usp_CalculateLoyaltyPoints" ;
		...
		#region Constructor
		public usp_CalculateLoyaltyPoints()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "usp_CalculateLoyaltyPoints";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "usp_CalculateLoyaltyPoints";
