...
{
	public class spUpdateDTUSER_TERRITORY
	{
		#region Private Members
		private string sp_Name = " spUpdateDTUSER_TERRITORY" ;
		...
		#region Constructor
		public spUpdateDTUSER_TERRITORY()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTUSER_TERRITORY";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTUSER_TERRITORY";
