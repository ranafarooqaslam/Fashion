...
{
	public class uspSelectOrderBrooker
	{
		#region Private Members
		private string sp_Name = " uspSelectOrderBrooker" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectOrderBrooker";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectOrderBrooker";
