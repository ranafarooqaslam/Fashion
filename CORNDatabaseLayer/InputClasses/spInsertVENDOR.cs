...
{
	public class spInsertVENDOR
	{
		#region Private Members
		private string sp_Name = "spInsertVENDOR" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.ExecuteNonQuery();
				m_VENDOR_ID = (int)((IDataParameter)(cmd.Parameters["@VENDOR_ID"])).Value;
				return true;
			}
			catch(Exception e)
			{
		...
		public void FirstReader(IDataReader dr)
		{
			if(dr.Read())
			{
				...
				m_PRINCIPAL_ID= Convert.ToInt32(dr["CURRENCY_ID"]);
