...
{
	public class spSelectSCH_RECIPIENT
	{
		#region Private Members
		private string sp_Name = " spSelectSCH_RECIPIENT" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectSCH_RECIPIENT";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectSCH_RECIPIENT";
