...
{
	public class UspGetSlabDetail_OfferSKUID
	{
		#region Private Members
		private string sp_Name = " UspGetSlabDetail_OfferSKUID" ;
		...
		#region Constructor
		public UspGetSlabDetail_OfferSKUID()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "UspGetSlabDetail_OfferSKUID";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "UspGetSlabDetail_OfferSKUID";
