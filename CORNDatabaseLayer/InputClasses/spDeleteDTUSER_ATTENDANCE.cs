...
{
	public class spDeleteDTUSER_ATTENDANCE
	{
		#region Private Members
		private string sp_Name = " spDeleteDTUSER_ATTENDANCE" ;
		...
		#region Constructor
		public spDeleteDTUSER_ATTENDANCE()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteDTUSER_ATTENDANCE";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteDTUSER_ATTENDANCE";
