...
{
	public class spUpdateSLASH_USER
	{
		#region Private Members
		private string sp_Name = " spUpdateSLASH_USER" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateSLASH_USER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateSLASH_USER";
