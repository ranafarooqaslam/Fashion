...
{
	public class uspGetCashClosing
	{
		#region Private Members
		private string sp_Name = " uspGetCashClosing" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspGetCashClosing";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspGetCashClosing";
