...
{
	public class spInsertDISTRIBUTOR_ROUTE
	{
		#region Private Members
		private string sp_Name = " spInsertDISTRIBUTOR_ROUTE" ;
		...
		#region Constructor
		public spInsertDISTRIBUTOR_ROUTE()
		{
		m_ROUTE_ID =  Constants.LongNullValue;
		m_TOWN_ID =  Constants.LongNullValue;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDISTRIBUTOR_ROUTE";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDISTRIBUTOR_ROUTE";
