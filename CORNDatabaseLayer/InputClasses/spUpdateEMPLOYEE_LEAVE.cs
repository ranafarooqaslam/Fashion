...
{
    public class spUpdateEMPLOYEE_LEAVE
    {
        #region Private Members
        private string sp_Name = " spUpdateEMPLOYEE_LEAVE";
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "spUpdateEMPLOYEE_LEAVE";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "spUpdateEMPLOYEE_LEAVE";
