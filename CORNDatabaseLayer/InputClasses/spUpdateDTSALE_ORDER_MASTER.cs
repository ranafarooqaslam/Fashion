...
{
	public class spUpdateDTSALE_ORDER_MASTER
	{
		#region Private Members
		private string sp_Name = " spUpdateDTSALE_ORDER_MASTER" ;
		...
		#region Constructor
		public spUpdateDTSALE_ORDER_MASTER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTSALE_ORDER_MASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTSALE_ORDER_MASTER";
