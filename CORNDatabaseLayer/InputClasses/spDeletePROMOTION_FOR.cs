...
{
	public class spDeletePROMOTION_FOR
	{
		#region Private Members
		private string sp_Name = " spDeletePROMOTION_FOR" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeletePROMOTION_FOR";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeletePROMOTION_FOR";
