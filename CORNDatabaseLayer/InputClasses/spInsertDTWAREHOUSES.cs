...
{
	public class spInsertDTWAREHOUSES
	{
		#region Private Members
		private string sp_Name = " spInsertDTWAREHOUSES" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTWAREHOUSES";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTWAREHOUSES";
