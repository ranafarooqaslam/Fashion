...
{
	public class uspSelectPROMOTION_OFFER_dt
	{
		#region Private Members
		private string sp_Name = " uspSelectPROMOTION_OFFER_dt" ;
		...
		#region Constructor
		public uspSelectPROMOTION_OFFER_dt()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectPROMOTION_OFFER_dt";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectPROMOTION_OFFER_dt";
...
/*			****** COMMENTED DUE TO DEFAULT ERROR IN CLASS GENERATION*****
 * 
			public void FirstReader(IDataReader dr)
			{
				if(dr.Read())
				{
					...
					m_DISCOUNT= Convert.ToDouble(dr["DISCOUNT"]);
