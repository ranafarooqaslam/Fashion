...
{
	public class spSelectDISTRIBUTOR
	{
		#region Private Members
		private string sp_Name = " spSelectDISTRIBUTOR" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectDISTRIBUTOR";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectDISTRIBUTOR";
		    ...
		    public void GetParameterCollection(ref IDbCommand cmd)
		{
			...
			if(m_IS_REGISTERED==1)
			{
				parameter.Value = true;
			}
			else
			if(m_IS_REGISTERED==0)
			{
				parameter.Value = false;
			}
			pparams.Add(parameter);
