...
{
	public class spInsertDTSALE_INVOICE_TLP
	{
		#region Private Members
		private string sp_Name = " spInsertDTSALE_INVOICE_TLP" ;
		...
		#region Constructor
		public spInsertDTSALE_INVOICE_TLP()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTSALE_INVOICE_TLP";
				...
				cmd.ExecuteNonQuery();
				m_SALE_INVOICE_TLP_ID = (long)((IDataParameter)(cmd.Parameters["@SALE_INVOICE_TLP_ID"])).Value;
				return true;
			}
			catch(Exception e)
			{
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTSALE_INVOICE_TLP";
