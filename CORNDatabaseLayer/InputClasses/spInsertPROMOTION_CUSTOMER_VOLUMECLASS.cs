...
namespace CORNDatabaseLayer.Classes
{
	public class spInsertPROMOTION_CUSTOMER_VOLUMECLASS
	{
		...
		private string sp_Name = " spInsertPROMOTION_CUSTOMER_VOLUMECLASS" ;
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertPROMOTION_CUSTOMER_VOLUMECLASS";
		...
		public string ExecuteScalar()
		{
			...
			public void FirstReader(IDataReader dr)
			{
				if(dr.Read())
				{
					...
					m_PROMOTION_VOLUMECLASS_ID=Convert.ToInt64(dr["PROMOTION_VOLUMECLASS_ID"]);
					m_SCHEME_ID= Convert.ToInt32(dr["SCHEME_ID"]);
					m_DISTRIBUTOR_ID= Convert.ToInt32(dr["DISTRIBUTOR_ID"]);
					m_CUSTOMER_VOLUMECLASS_ID= Convert.ToInt32(dr["CUSTOMER_VOLUMECLASS_ID"]);
				}
			}
