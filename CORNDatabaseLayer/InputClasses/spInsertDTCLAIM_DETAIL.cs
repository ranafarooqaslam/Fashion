...
{
	public class spInsertDTCLAIM_DETAIL
	{
		#region Private Members
		private string sp_Name = " spInsertDTCLAIM_DETAIL" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTCLAIM_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTCLAIM_DETAIL";
