...
{
	public class spUpdateDTCUSTOMER_TLP_PERSON
	{
		#region Private Members
		private string sp_Name = " spUpdateDTCUSTOMER_TLP_PERSON" ;
		...
		#region Constructor
		public spUpdateDTCUSTOMER_TLP_PERSON()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTCUSTOMER_TLP_PERSON";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTCUSTOMER_TLP_PERSON";
