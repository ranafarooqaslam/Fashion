...
{
	public class spUpdateDTROLE_DETAIL
	{
		#region Private Members
		private string sp_Name = " spUpdateDTROLE_DETAIL" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTROLE_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTROLE_DETAIL";
