...
{
	public class spSelectSKU_STOCK_REGISTER
	{
		#region Private Members
		private string sp_Name = " spSelectSKU_STOCK_REGISTER" ;
		...
		#region Constructor
		public spSelectSKU_STOCK_REGISTER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectSKU_STOCK_REGISTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectSKU_STOCK_REGISTER";
