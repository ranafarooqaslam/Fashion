...
{
	public class usp_deliveryman_Invoiced
	{
		#region Private Members
		private string sp_Name = " usp_deliveryman_Invoiced" ;
		...
		#region Constructor
		public usp_deliveryman_Invoiced()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "usp_deliveryman_Invoiced";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "usp_deliveryman_Invoiced";
