...
{
	public class spInsertSKU_TAX
	{
		#region Private Members
		private string sp_Name = " spInsertSKU_TAX" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertSKU_TAX";
				...
				cmd.ExecuteNonQuery();
				m_SKU_TAX_ID = (int)((IDataParameter)(cmd.Parameters["@SKU_TAX_ID"])).Value;
				return true;
			}
			catch(Exception e)
			{
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertSKU_TAX";
