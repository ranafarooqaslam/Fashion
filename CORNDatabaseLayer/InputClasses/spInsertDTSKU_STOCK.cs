...
{
	public class spInsertDTSKU_STOCK
	{
		#region Private Members
		private string sp_Name = " spInsertDTSKU_STOCK" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTSKU_STOCK";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTSKU_STOCK";
