...
{
	public class SelectBankTransction
	{
		#region Private Members
		private string sp_Name = " SelectBankTransction" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "SelectBankTransction";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "SelectBankTransction";
