...
{
	public class spUpdatePURCHASE_PROMOTION
	{
		#region Private Members
		private string sp_Name = " spUpdatePURCHASE_PROMOTION" ;
		...
		#region Constructor
		public spUpdatePURCHASE_PROMOTION()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdatePURCHASE_PROMOTION";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdatePURCHASE_PROMOTION";
