...
{
	public class spSelectSALE_INVOICE_DETAIL
	{
		#region Private Members
		private string sp_Name = " spSelectSALE_INVOICE_DETAIL" ;
		...
		#region Constructor
		public spSelectSALE_INVOICE_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectSALE_INVOICE_DETAIL";
