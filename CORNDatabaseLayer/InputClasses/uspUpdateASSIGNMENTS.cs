...
{
	public class uspUpdateASSIGNMENTS
	{
		#region Private Members
		private string sp_Name = " uspUpdateASSIGNMENTS" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspUpdateASSIGNMENTS";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspUpdateASSIGNMENTS";
