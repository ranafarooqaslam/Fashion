...
{
	public class spUpdateDTBASKET_MASTER
	{
		#region Private Members
		private string sp_Name = " spUpdateDTBASKET_MASTER" ;
		...
		#region Constructor
		public spUpdateDTBASKET_MASTER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTBASKET_MASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTBASKET_MASTER";
