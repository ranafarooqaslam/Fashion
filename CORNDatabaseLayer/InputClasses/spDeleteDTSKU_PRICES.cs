...
{
	public class spDeleteDTSKU_PRICES
	{
		#region Private Members
		private string sp_Name = " spDeleteDTSKU_PRICES" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteDTSKU_PRICES";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteDTSKU_PRICES";
