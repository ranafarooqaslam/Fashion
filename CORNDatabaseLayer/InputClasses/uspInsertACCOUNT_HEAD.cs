...
{
	public class uspInsertACCOUNT_HEAD
	{
		#region Private Members
		private string sp_Name = " uspInsertACCOUNT_HEAD" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspInsertACCOUNT_HEAD";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspInsertACCOUNT_HEAD";
