...
{
	public class spDeleteDTSTOCK_ADJUSTMENT_DETAIL
	{
		#region Private Members
		private string sp_Name = " spDeleteDTSTOCK_ADJUSTMENT_DETAIL" ;
		...
		#region Constructor
		public spDeleteDTSTOCK_ADJUSTMENT_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteDTSTOCK_ADJUSTMENT_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteDTSTOCK_ADJUSTMENT_DETAIL";
