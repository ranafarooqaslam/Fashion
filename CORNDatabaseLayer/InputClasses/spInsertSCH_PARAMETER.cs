...
{
	public class spInsertSCH_PARAMETER
	{
		#region Private Members
		private string sp_Name = " spInsertSCH_PARAMETER" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertSCH_PARAMETER";
				...
				cmd.ExecuteNonQuery();
				m_SCH_PARAM_ID = (int)((IDataParameter)(cmd.Parameters["@SCH_PARAM_ID"])).Value;
				return true;
			}
			catch(Exception e)
			{
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertSCH_PARAMETER";
