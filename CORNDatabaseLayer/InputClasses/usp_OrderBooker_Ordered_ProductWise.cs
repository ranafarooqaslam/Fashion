...
{
	public class usp_OrderBooker_Ordered_ProductWise
	{
		#region Private Members
		private string sp_Name = " usp_OrderBooker_Ordered_ProductWise" ;
		...
		#region Constructor
		public usp_OrderBooker_Ordered_ProductWise()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "usp_OrderBooker_Ordered_ProductWise";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "usp_OrderBooker_Ordered_ProductWise";
