...
{
	public class spPROCESSPROMOTION_CUSTOMER_TYPE
	{
		#region Private Members
		private string sp_Name = " spPROCESSPROMOTION_CUSTOMER_TYPE" ;
		...
		#region Constructor
		public spPROCESSPROMOTION_CUSTOMER_TYPE()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spPROCESSPROMOTION_CUSTOMER_TYPE";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spPROCESSPROMOTION_CUSTOMER_TYPE";
