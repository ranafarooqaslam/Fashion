...
{
	public class uspHHSelectTLPPerson
	{
		#region Private Members
		private string sp_Name = " uspHHSelectTLPPerson" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspHHSelectTLPPerson";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspHHSelectTLPPerson";
