...
{
	public class spDeleteDTTARGET
	{
		#region Private Members
		private string sp_Name = " spDeleteDTTARGET" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteDTTARGET";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteDTTARGET";
