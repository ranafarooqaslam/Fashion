...
{
	public class spSelectDTSKU_GROUP
	{
		#region Private Members
		private string sp_Name = " spSelectDTSKU_GROUP" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectDTSKU_GROUP";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectDTSKU_GROUP";
...
//					m_GROUP_NAME= Convert.ToString(first_row["GROUP_NAME"]);
