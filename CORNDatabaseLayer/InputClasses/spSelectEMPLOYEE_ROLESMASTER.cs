...
{
	public class spSelectEMPLOYEE_ROLESMASTER
	{
		#region Private Members
		private string sp_Name = " spSelectEMPLOYEE_ROLESMASTER" ;
		...
		#region Constructor
		public spSelectEMPLOYEE_ROLESMASTER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectEMPLOYEE_ROLESMASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectEMPLOYEE_ROLESMASTER";
