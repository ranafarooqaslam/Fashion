...
{
	public class spInsertDTPROMOTION
	{
		#region Private Members
		private string sp_Name = " spInsertDTPROMOTION" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTPROMOTION";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTPROMOTION";
