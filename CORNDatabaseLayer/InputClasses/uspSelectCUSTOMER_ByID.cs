...
{
	public class uspSelectCUSTOMER_ByID
	{
		#region Private Members
		private string sp_Name = " uspSelectCUSTOMER_ByID" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectCUSTOMER_ByID";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectCUSTOMER_ByID";
