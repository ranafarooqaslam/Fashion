...
{
	public class UspUpdateGroupandGroupDetail
	{
		#region Private Members
		private string sp_Name = " UspUpdateGroupandGroupDetail" ;
		...
		#region Constructor
		public UspUpdateGroupandGroupDetail()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "UspUpdateGroupandGroupDetail";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "UspUpdateGroupandGroupDetail";
