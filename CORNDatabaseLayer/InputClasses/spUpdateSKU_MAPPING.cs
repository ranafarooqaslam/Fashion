...
{
	public class spUpdateSKU_MAPPING
	{
		#region Private Members
		private string sp_Name = " spUpdateSKU_MAPPING" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateSKU_MAPPING";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateSKU_MAPPING";
