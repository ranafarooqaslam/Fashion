...
{
	public class spDeleteSTOCK_ADJUSTMENT_DETAIL
	{
		#region Private Members
		private string sp_Name = " spDeleteSTOCK_ADJUSTMENT_DETAIL" ;
		...
		#region Constructor
		public spDeleteSTOCK_ADJUSTMENT_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteSTOCK_ADJUSTMENT_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteSTOCK_ADJUSTMENT_DETAIL";
