...
{
	public class uspSelectSALE_INVOICE_DETAIL
	{
		#region Private Members
		private string sp_Name = " uspSelectSALE_INVOICE_DETAIL" ;
		...
		#region Constructor
		public uspSelectSALE_INVOICE_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectSALE_INVOICE_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectSALE_INVOICE_DETAIL";
