...
{
	public class uspHHGetSaleOrders
	{
		#region Private Members
		private string sp_Name = " uspHHGetSaleOrders" ;
		private IDbConnection m_connection;
		private IDbTransaction m_transaction;


		private bool m_ISIMPORTDATE;
		...
		public bool ISIMPORTDATE
		{
			set
			{
				m_ISIMPORTDATE = value ;
			}
			get
			{
				return m_ISIMPORTDATE;
			}
		}
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspHHGetSaleOrders";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspHHGetSaleOrders";
		...
		public string ExecuteScalar()
		{
			...
			public void FirstReader(IDataReader dr)
			{
				if(dr.Read())
				{
					m_ISIMPORTDATE=Convert.ToBoolean(dr["ISIMPORTDATE"]);
		    ...
		    public void GetParameterCollection(ref IDbCommand cmd)
		{
			...
			parameter.ParameterName = "@ISIMPORTDATE" ; 
			parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.Bit);
				parameter.Value = m_ISIMPORTDATE;
