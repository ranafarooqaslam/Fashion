...
{
	public class spUpdateSYNC_LOG_DETAIL
	{
		#region Private Members
		private string sp_Name = " spUpdateSYNC_LOG_DETAIL" ;
		private IDbConnection m_connection;
		private IDbTransaction m_transaction;


		private long m_SYNC_LOG_DETAIL_ID;
		private char m_SP_NAME;
		...
		#region Constructor
		public spUpdateSYNC_LOG_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateSYNC_LOG_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateSYNC_LOG_DETAIL";
...
//					m_SP_NAME= Convert.ToChar(dr["SP_NAME"]);
...
//			}
		    ...
		    public void GetParameterCollection(ref IDbCommand cmd)
		{
			...
			if(m_SYNC_LOG_DETAIL_ID==Constants.LongNullValue)
			{
				parameter.Value = DBNull.Value;
			}
			else
			{
				parameter.Value = m_SYNC_LOG_DETAIL_ID;
			}
