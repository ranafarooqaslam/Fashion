...
{
	public class spDeleteCLAIM_DETAIL
	{
		#region Private Members
		private string sp_Name = " spDeleteCLAIM_DETAIL" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteCLAIM_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteCLAIM_DETAIL";
