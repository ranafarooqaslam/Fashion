...
{
	public class UspGetAssignedUnassignedBrand
	{
		#region Private Members
		private string sp_Name = " UspGetAssignedUnassignedBrand" ;
		...
		#region Constructor
		public UspGetAssignedUnassignedBrand()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "UspGetAssignedUnassignedBrand";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "UspGetAssignedUnassignedBrand";
