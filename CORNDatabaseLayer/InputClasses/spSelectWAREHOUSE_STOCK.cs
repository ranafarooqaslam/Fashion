...
{
	public class spSelectWAREHOUSE_STOCK
	{
		#region Private Members
		private string sp_Name = " spSelectWAREHOUSE_STOCK" ;
		...
		#region Constructor
		public spSelectWAREHOUSE_STOCK()
		{
            
			m_WAREHOUSE_STOCK_ID=Constants.IntNullValue;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectWAREHOUSE_STOCK";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectWAREHOUSE_STOCK";
