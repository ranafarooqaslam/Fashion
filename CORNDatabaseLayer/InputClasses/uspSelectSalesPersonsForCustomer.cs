...
{
	public class uspSelectSalesPersonsForCustomer
	{
		#region Private Members
		private string sp_Name = " uspSelectSalesPersonsForCustomer" ;
		...
		#region Constructor
		public uspSelectSalesPersonsForCustomer()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectSalesPersonsForCustomer";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectSalesPersonsForCustomer";
