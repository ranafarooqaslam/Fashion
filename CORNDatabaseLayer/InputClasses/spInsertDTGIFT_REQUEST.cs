...
{
	public class spInsertDTGIFT_REQUEST
	{
		#region Private Members
		private string sp_Name = " spInsertDTGIFT_REQUEST" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTGIFT_REQUEST";
				...
				cmd.ExecuteNonQuery();
				m_GIFT_REQUEST_ID = (int)((IDataParameter)(cmd.Parameters["@GIFT_REQUEST_ID"])).Value;
				return true;
			}
			catch(Exception e)
			{
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTGIFT_REQUEST";
