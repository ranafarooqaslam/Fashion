...
{
	public class uspHHSelectSetting
	{
		#region Private Members
		private string sp_Name = " uspHHSelectSetting" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspHHSelectSetting";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspHHSelectSetting";
