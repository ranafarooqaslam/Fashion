...
{
	public class spDeleteDTCLAIM_DETAIL
	{
		#region Private Members
		private string sp_Name = " spDeleteDTCLAIM_DETAIL" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteDTCLAIM_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteDTCLAIM_DETAIL";
