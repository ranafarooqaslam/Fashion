...
{
	public class spInsertDTSALES_RETURN_DETAIL
	{
		#region Private Members
		private string sp_Name = " spInsertDTSALES_RETURN_DETAIL" ;
		...
		#region Constructor
		public spInsertDTSALES_RETURN_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTSALES_RETURN_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTSALES_RETURN_DETAIL";
