...
{
	public class uspSelectSALES_RETURN_MASTER
	{
		#region Private Members
		private string sp_Name = " uspSelectSALES_RETURN_MASTER" ;
		...
		#region Constructor
		public uspSelectSALES_RETURN_MASTER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectSALES_RETURN_MASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectSALES_RETURN_MASTER";
