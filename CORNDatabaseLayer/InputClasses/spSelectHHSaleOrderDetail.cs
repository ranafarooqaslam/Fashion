...
{
	public class spSelectHHSaleOrderDetail
	{
		#region Private Members
		private string sp_Name = " spSelectHHSaleOrderDetail" ;
		...
		#region Constructor
		public spSelectHHSaleOrderDetail()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectHHSaleOrderDetail";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectHHSaleOrderDetail";
