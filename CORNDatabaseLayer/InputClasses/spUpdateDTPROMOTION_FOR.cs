...
{
	public class spUpdateDTPROMOTION_FOR
	{
		#region Private Members
		private string sp_Name = " spUpdateDTPROMOTION_FOR" ;
		...
		#region Constructor
		public spUpdateDTPROMOTION_FOR()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTPROMOTION_FOR";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTPROMOTION_FOR";
