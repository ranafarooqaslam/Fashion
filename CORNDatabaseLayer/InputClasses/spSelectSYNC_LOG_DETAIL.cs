...
{
	public class spSelectSYNC_LOG_DETAIL
	{
		#region Private Members
		private string sp_Name = " spSelectSYNC_LOG_DETAIL" ;
		...
		#region Constructor
		public spSelectSYNC_LOG_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectSYNC_LOG_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectSYNC_LOG_DETAIL";
