...
{
	public class spUpdateSALE_ORDER_PROMOTION
	{
		#region Private Members
		private string sp_Name = " spUpdateSALE_ORDER_PROMOTION" ;
		...
		#region Constructor
		public spUpdateSALE_ORDER_PROMOTION()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateSALE_ORDER_PROMOTION";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateSALE_ORDER_PROMOTION";
