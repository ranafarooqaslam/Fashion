...
{
	public class spDeleteLOYALTY_POINTS
	{
		#region Private Members
		private string sp_Name = " spDeleteLOYALTY_POINTS" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteLOYALTY_POINTS";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteLOYALTY_POINTS";
