...
{
	public class uspSelectPurchaseMaster
	{
		#region Private Members
		private string sp_Name = " uspSelectPurchaseMaster" ;
		...
		#region Constructor
		public uspSelectPurchaseMaster()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectPurchaseMaster";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectPurchaseMaster";
