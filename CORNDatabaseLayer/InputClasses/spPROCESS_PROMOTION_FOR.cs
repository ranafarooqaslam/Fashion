...
{
	public class spPROCESS_PROMOTION_FOR
	{
		#region Private Members
		private string sp_Name = " spPROCESS_PROMOTION_FOR" ;
		...
		#region Constructor
		public spPROCESS_PROMOTION_FOR()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spPROCESS_PROMOTION_FOR";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spPROCESS_PROMOTION_FOR";
