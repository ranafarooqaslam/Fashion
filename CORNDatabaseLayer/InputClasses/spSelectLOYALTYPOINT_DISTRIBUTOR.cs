...
{
	public class spSelectLOYALTYPOINT_DISTRIBUTOR
	{
		#region Private Members
		private string sp_Name = " spSelectLOYALTYPOINT_DISTRIBUTOR" ;
		...
		#region Constructor
		public spSelectLOYALTYPOINT_DISTRIBUTOR()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectLOYALTYPOINT_DISTRIBUTOR";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectLOYALTYPOINT_DISTRIBUTOR";
