...
{
	public class spUpdateCLAIM_APPROVAL
	{
		#region Private Members
		private string sp_Name = " spUpdateCLAIM_APPROVAL" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateCLAIM_APPROVAL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateCLAIM_APPROVAL";
