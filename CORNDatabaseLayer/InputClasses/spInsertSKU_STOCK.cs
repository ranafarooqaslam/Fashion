...
{
	public class spInsertSKU_STOCK
	{
		#region Private Members
		private string sp_Name = " spInsertSKU_STOCK" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertSKU_STOCK";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertSKU_STOCK";
