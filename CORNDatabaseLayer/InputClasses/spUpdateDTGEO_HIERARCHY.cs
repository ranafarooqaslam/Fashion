...
{
	public class spUpdateDTGEO_HIERARCHY
	{
		#region Private Members
		private string sp_Name = " spUpdateDTGEO_HIERARCHY" ;
		...
		#region Constructor
		public spUpdateDTGEO_HIERARCHY()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTGEO_HIERARCHY";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTGEO_HIERARCHY";
