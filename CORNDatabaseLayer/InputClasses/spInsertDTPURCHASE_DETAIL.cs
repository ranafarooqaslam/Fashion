...
{
	public class spInsertDTPURCHASE_DETAIL
	{
		#region Private Members
		private string sp_Name = " spInsertDTPURCHASE_DETAIL" ;
		...
		#region Constructor
		public spInsertDTPURCHASE_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTPURCHASE_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTPURCHASE_DETAIL";
