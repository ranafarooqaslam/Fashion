...
{
	public class uspSelectBASKET_MASTER
	{
		#region Private Members
		private string sp_Name = " uspSelectBASKET_MASTER" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectBASKET_MASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectBASKET_MASTER";
		...
		public void FirstReader(IDataReader dr)
		{
			if(dr.Read())
			{
				...
				m_IS_AND= Convert.ToInt32(dr["IS_AND"]);
				...
				m_BASKET_ON= Convert.ToInt16(dr["BASKET_ON"]);
			}
		}
