...
{
	public class spInsertGEO_HIERARCHY
	{
		#region Private Members
		private string sp_Name = " spInsertGEO_HIERARCHY" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertGEO_HIERARCHY";
				cmd.Connection =   m_connection;
				GetParameterCollection(ref cmd);
				cmd.ExecuteNonQuery();
				m_GEO_ID = (int)((IDataParameter)(cmd.Parameters["@GEO_ID"])).Value;
				return true;
			}
			catch(Exception e)
			{
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertGEO_HIERARCHY";
