...
{
	public class spSelectCUSTOMER_TLP_PERSON
	{
		#region Private Members
		private string sp_Name = " spSelectCUSTOMER_TLP_PERSON" ;
		...
		#region Constructor
		public spSelectCUSTOMER_TLP_PERSON()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectCUSTOMER_TLP_PERSON";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectCUSTOMER_TLP_PERSON";
