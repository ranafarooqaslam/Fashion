...
{
	public class spSelectSAMS_USER_01
	{
		#region Private Members
		private string sp_Name = " spSelectSAMS_USER_01" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectSAMS_USER_01";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectSAMS_USER_01";
