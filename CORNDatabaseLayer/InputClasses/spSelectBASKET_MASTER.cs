...
{
	public class spSelectBASKET_MASTER
	{
		#region Private Members
		private string sp_Name = " spSelectBASKET_MASTER" ;
		...
		#region Constructor
		public spSelectBASKET_MASTER()
		{
		m_BASKET_ID = Constants.LongNullValue;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectBASKET_MASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectBASKET_MASTER";
