...
{
	public class uspUpdateSALEPERSON_TRANSCTION
	{
		#region Private Members
		private string sp_Name = " uspUpdateSALEPERSON_TRANSCTION" ;
		...
		#region Constructor
		public uspUpdateSALEPERSON_TRANSCTION()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspUpdateSALEPERSON_TRANSCTION";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspUpdateSALEPERSON_TRANSCTION";
