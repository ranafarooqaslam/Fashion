...
{
	public class spInsertVENDER_INVOICE_MASTER
	{
		#region Private Members
		private string sp_Name = "spInsertVENDER_INVOICE_MASTER" ;
		...
		#endregion
		#region Constructor
		public spInsertVENDER_INVOICE_MASTER()
		{
		}
		#endregion
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.ExecuteNonQuery();
                m_VENDER_INVOICE_ID = (long)((IDataParameter)(cmd.Parameters["@VENDER_INVOICE_ID"])).Value;
                return true;
			}
			catch(Exception e)
			{
