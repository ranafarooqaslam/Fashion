...
{
	public class spUpdateDTBASKET_DETAIL
	{
		#region Private Members
		private string sp_Name = " spUpdateDTBASKET_DETAIL" ;
		...
		#region Constructor
		public spUpdateDTBASKET_DETAIL()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTBASKET_DETAIL";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTBASKET_DETAIL";
