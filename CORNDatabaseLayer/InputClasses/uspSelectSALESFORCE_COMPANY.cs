...
{
	public class uspSelectSALESFORCE_COMPANY
	{
		#region Private Members
		private string sp_Name = " uspSelectSALESFORCE_COMPANY" ;
		...
		#region Constructor
		public uspSelectSALESFORCE_COMPANY()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectSALESFORCE_COMPANY";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectSALESFORCE_COMPANY";
