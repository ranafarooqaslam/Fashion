...
namespace CORNDatabaseLayer.Classes
{
	public class spInsertDISTRIBUTOR
	{
		...
		public bool PROMOTION_ON
        {
			set
			{
				m_PROMOTION_ON = value ;
			}
			get
			{
				return m_PROMOTION_ON;
			}
		}
		...
		public string ExecuteScalar()
		{
			...
			public void FirstReader(IDataReader dr)
			{
                ...
                m_PROMOTION_ON = Convert.ToBoolean(dr["PROMOTION_ON"]); 
                ...
                m_ImagePath = Convert.ToString(dr["IMAGE_PATH"]);
				}
			}
		    ...
		    public void GetParameterCollection(ref IDbCommand cmd)
		{
            ...
            parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
            parameter.ParameterName = "@PROMOTION_ON";
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.Bit);
            parameter.Value = m_PROMOTION_ON;
            pparams.Add(parameter);
            ...
            parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
            parameter.ParameterName = "@IMAGE_PATH";
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.VarChar);
            if (m_ImagePath == null)
            {
                parameter.Value = DBNull.Value;
