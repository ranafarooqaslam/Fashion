...
{
	public class spPROCESSBASKET_MASTER
	{
		#region Private Members
		private string sp_Name = " spPROCESSBASKET_MASTER" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spPROCESSBASKET_MASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spPROCESSBASKET_MASTER";
