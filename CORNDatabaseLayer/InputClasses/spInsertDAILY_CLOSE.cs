...
{
	public class spInsertDAILY_CLOSE
	{
		#region Private Members
		private string sp_Name = " spInsertDAILY_CLOSE" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDAILY_CLOSE";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDAILY_CLOSE";
