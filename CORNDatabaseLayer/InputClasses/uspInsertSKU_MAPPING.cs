...
{
	public class uspInsertSKU_MAPPING
	{
		#region Private Members
		private string sp_Name = " uspInsertSKU_MAPPING" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspInsertSKU_MAPPING";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspInsertSKU_MAPPING";
