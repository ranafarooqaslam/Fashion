...
{
	public class spDeleteDISTRIBUTOR_SETTINGS
	{
		#region Private Members
		private string sp_Name = " spDeleteDISTRIBUTOR_SETTINGS" ;
		...
		#region Constructor
		public spDeleteDISTRIBUTOR_SETTINGS()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteDISTRIBUTOR_SETTINGS";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteDISTRIBUTOR_SETTINGS";
