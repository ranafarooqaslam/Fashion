...
{
    public class uspGetPendingTaxAuthorityInvoices
    {
        #region Private Members
		private string sp_Name = "uspGetPendingTaxAuthorityInvoices" ;
		...
		#region Constructor
        public uspGetPendingTaxAuthorityInvoices()
        {
		...
		public bool  ExecuteQuery()
		{
			try
			{
                ...
                cmd.CommandText = "uspGetPendingTaxAuthorityInvoices";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
                ...
                command.CommandText = "uspGetPendingTaxAuthorityInvoices";
