...
{
	public class spDeleteDTSALE_ORDER_PROMOTION
	{
		#region Private Members
		private string sp_Name = " spDeleteDTSALE_ORDER_PROMOTION" ;
		...
		#region Constructor
		public spDeleteDTSALE_ORDER_PROMOTION()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteDTSALE_ORDER_PROMOTION";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteDTSALE_ORDER_PROMOTION";
