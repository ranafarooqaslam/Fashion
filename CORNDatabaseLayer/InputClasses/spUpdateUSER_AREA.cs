...
{
	public class spUpdateUSER_AREA
	{
		#region Private Members
		private string sp_Name = " spUpdateUSER_AREA" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateUSER_AREA";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateUSER_AREA";
