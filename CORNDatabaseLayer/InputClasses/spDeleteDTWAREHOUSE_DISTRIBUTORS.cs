...
{
	public class spDeleteDTWAREHOUSE_DISTRIBUTORS
	{
		#region Private Members
		private string sp_Name = " spDeleteDTWAREHOUSE_DISTRIBUTORS" ;
		...
		#region Constructor
		public spDeleteDTWAREHOUSE_DISTRIBUTORS()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spDeleteDTWAREHOUSE_DISTRIBUTORS";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spDeleteDTWAREHOUSE_DISTRIBUTORS";
