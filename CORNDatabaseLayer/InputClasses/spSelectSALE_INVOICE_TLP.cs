...
{
	public class spSelectSALE_INVOICE_TLP
	{
		#region Private Members
		private string sp_Name = " spSelectSALE_INVOICE_TLP" ;
		...
		#region Constructor
		public spSelectSALE_INVOICE_TLP()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectSALE_INVOICE_TLP";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectSALE_INVOICE_TLP";
