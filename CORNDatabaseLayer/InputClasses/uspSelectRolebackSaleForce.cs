...
{
	public class uspSelectRolebackSaleForce
	{
		#region Private Members
		private string sp_Name = " uspSelectRolebackSaleForce" ;
		...
		#region Constructor
		public uspSelectRolebackSaleForce()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectRolebackSaleForce";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectRolebackSaleForce";
