...
{
	public class spInsertDTPURCHASE_DISPUTE
	{
		#region Private Members
		private string sp_Name = " spInsertDTPURCHASE_DISPUTE" ;
		...
		#region Constructor
		public spInsertDTPURCHASE_DISPUTE()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertDTPURCHASE_DISPUTE";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spInsertDTPURCHASE_DISPUTE";
