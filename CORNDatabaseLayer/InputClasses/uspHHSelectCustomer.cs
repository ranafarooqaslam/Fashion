...
{
	public class uspHHSelectCustomer
	{
		#region Private Members
		private string sp_Name = " uspHHSelectCustomer" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspHHSelectCustomer";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspHHSelectCustomer";
