...
{
	public class spUpdateDTSALE_INVOICE_MASTER
	{
		#region Private Members
		private string sp_Name = " spUpdateDTSALE_INVOICE_MASTER" ;
		...
		#region Constructor
		public spUpdateDTSALE_INVOICE_MASTER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdateDTSALE_INVOICE_MASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdateDTSALE_INVOICE_MASTER";
