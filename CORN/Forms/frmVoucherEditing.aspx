<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmVoucherEditing.aspx.cs"
            ...
            <table width="100%" style="font-size: 0.78em">
                <tr>
                    ...
                    <td align="center" style="height: 13px">
                                ...
                                <table>
                                    <tr>
                                        <td align="left" style="height: 25px;">
                                            <asp:Label ID="Label4" runat="server" Text="Location" Width="97px"></asp:Label>
                                        </td>
                                        <td align="left" style="height: 20px;">
                                            <asp:DropDownList ID="drpDistributor" runat="server" CssClass="DropList" Width="206px"
                                                Enabled="False">
                                            </asp:DropDownList>
                                        </td>
                                        <td align="left">
                                        ...
                                        <td align="left" style="width: 99px">
                                            <asp:Label ID="Label5" runat="server" CssClass="lblbox" Text="Voucher Type" Width="123px"></asp:Label>
                                        </td>
                                        <td align="left">
                                            <asp:DropDownList ID="DrpVoucherType" runat="server" CssClass="DropList" Width="205px"
                                                Enabled="False">
                                    ...
                                    <tr>
                                        <td align="left" style="height: 25px;">
                                            <asp:Label ID="Label6" runat="server" CssClass="lblbox" Text="Voucher Date" Width="117px"></asp:Label>
                                        </td>
                                        <td align="left" style="height: 20px;">
                                            <asp:TextBox ID="txtVoucherDate" runat="server" CssClass="txtBox " Width="200px"
                                                ReadOnly="True"></asp:TextBox>
                                        </td>
                                        <td align="left" style="height: 18px">
                                        </td>
                                        <td align="left" style="height: 18px; width: 99px;">
                                            <asp:Label ID="Label1" runat="server" CssClass="lblbox" Text="Voucher No" Width="72px"></asp:Label>
                                        </td>
                                        <td align="left" style="height: 18px">
                                            <asp:TextBox ID="lblVoucherNo" runat="server" CssClass="txtBox " Width="200px" ReadOnly="True"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left" style="height: 25px;">
                                            <asp:Label ID="Label9" runat="server" CssClass="lblbox" Text="Payment Mode" Width="105px"></asp:Label>
                                        </td>
                                        <td align="left" style="height: 20px;">
                                        ...
                                        <td align="left" style="width: 99px">
                                            <asp:Label ID="Label7" runat="server" CssClass="lblbox" Text="Slip No" Width="91px"></asp:Label>
                                        </td>
                                        <td align="left" style="height: 20px">
                                    ...
                                    <tr>
                                        <td align="left" style="height: 25px;">
                                            <asp:Label ID="lblChequeNo" runat="server" CssClass="lblbox" Text="Cheque No" Width="108px"></asp:Label>
                                        </td>
                                        <td align="left" style="height: 20px;">
                                            <asp:TextBox ID="txtChequeNo" runat="server" CssClass="txtBox " Width="200px"></asp:TextBox>
                                        </td>
                                        <td align="left" style="height: 20px">
                                        </td>
                                    ...
                                    <tr>
                                        <td align="left" style="height: 25px;">
                                            <asp:Label ID="Label10" runat="server" CssClass="lblbox" Text="Payee's Name" Width="117px"></asp:Label>
                                        </td>
                                        <td align="left" style="height: 25px">
                                            <asp:TextBox ID="txtpayeesName" runat="server" CssClass="txtBox " Width="200px" ></asp:TextBox>
                                           
                                        </td>
                                        <td align="left" style="height: 25px">
                                            <asp:Label ID="Label14" runat="server" CssClass="lblbox" Width="10px"></asp:Label>
                                        </td>
                                        <td align="left" style="height: 25px; width: 99px;">
                                            <asp:Label ID="Label2" runat="server" CssClass="lblbox" Text="Due Date" Width="85px"></asp:Label>
                                        </td>
                                        <td align="left" style="height: 25px">
                                    ...
                                    <tr>
                                        <td align="left" style="height: 25px">
                                            <asp:Label ID="Label3" runat="server" CssClass="lblbox" Text="Narration" Width="85px"></asp:Label>
                                        </td>
                                        <td align="left" style="height: 25px">
                                            <asp:TextBox ID="txtRemarks" runat="server" CssClass="txtBox " Width="200px" MaxLength="255"></asp:TextBox>
                                        </td>
                                        <td align="left" style="height: 25px">
                                        </td>
                                ...
                                <cc1:MaskedEditExtender ID="MaskedEditExtender2" runat="server" Mask="99/999/9999"
                                    MaskType="Date" TargetControlID="txtVoucherDate">
                                </cc1:MaskedEditExtender>
                                <cc1:MaskedEditExtender ID="MaskedEditExtender3" runat="server" Mask="99/999/9999"
                                    ...
                                    <tr>
                                        <td style="height: 16px">
                                            <asp:Label ID="lblskuCode" runat="server" BackColor="#007395" Font-Bold="True" ForeColor="White"
                                                Height="16px" Text="Acct Code" Width="83px" CssClass="lblbox" Font-Size="X-Small"></asp:Label>
                                        </td>
                                        <td style="height: 16px">
                                            <asp:Label ID="Label13" runat="server" BackColor="#007395" Font-Bold="True" ForeColor="White"
                                                Height="16px" Text="Description" Width="163px" Font-Size="X-Small"></asp:Label>
                                        </td>
                                        <td style="width: 196px; height: 16px">
                                            <asp:Label ID="lblskuname" runat="server" BackColor="#007395" Font-Bold="True" ForeColor="White"
                                                Height="16px" Text="Remarks" Width="146px" Font-Size="X-Small"></asp:Label>
                                        </td>
                                        <td style="width: 196px; height: 16px">
                                            <asp:Label ID="Label15" runat="server" BackColor="#007395" Font-Bold="True" ForeColor="White"
                                                Height="16px" Text="Principal" Width="135px" Font-Size="X-Small"></asp:Label>
                                        </td>
                                        <td style="height: 16px">
                                            <asp:Label ID="Label11" runat="server" BackColor="#007395" Font-Bold="True" ForeColor="White"
                                                Height="16px" Text="Debit" Width="89px" Font-Size="X-Small"></asp:Label>
                                        </td>
                                        <td style="height: 16px">
                                            <asp:Label ID="Label12" runat="server" BackColor="#007395" Font-Bold="True" ForeColor="White"
                                                Height="16px" Text="Credit" Width="87px" Font-Size="X-Small"></asp:Label>
                                        </td>
                                        <td style="height: 16px">
                                        </td>
                                        <td style="width: 79px; height: 16px">
                                            <asp:Label ID="Label8" runat="server" BackColor="#007395" Font-Bold="True" ForeColor="White"
                                                Height="16px" Width="69px" Font-Size="X-Small"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="height: 12px">
                                            <asp:TextBox ID="txtAccountCode" runat="server" CssClass="txtBox " onkeyup="SearchList()"
                                                Width="76px" Font-Size="X-Small"></asp:TextBox>
                                        </td>
                                        <td colspan="1" rowspan="1">
                                            <asp:TextBox ID="txtAccountName" runat="server" CssClass="txtBox " Enabled="False"
                                                Font-Bold="False" ForeColor="Black" Width="156px" Font-Size="X-Small"></asp:TextBox>
                                        </td>
                                        <td style="width: 196px; height: 12px">
                                            <asp:TextBox ID="txtAccountDes" runat="server" CssClass="txtBox " onfocus="SearchedCode();"
                                                Width="140px" Font-Size="X-Small"></asp:TextBox>
                                        </td>
                                        <td style="width: 196px; height: 12px">
                                            <asp:DropDownList ID="DrpPrincipal" runat="server" CssClass="DropList" Width="133px"
                                                Font-Size="X-Small">
                                            </asp:DropDownList>
                                        </td>
                                        <td style="height: 12px">
                                            <asp:TextBox ID="txtDebitAmount" runat="server" CssClass="txtBox " Width="80px" Font-Size="X-Small"></asp:TextBox>
                                        </td>
                                        <td style="height: 12px">
                                            <asp:TextBox ID="txtCreditAmount" runat="server" CssClass="txtBox " Width="80px"
                                    ...
                                    <tr>
                                        <td align="center" colspan="8" rowspan="1">
                                            <asp:GridView ID="GrdOrder" runat="server" AutoGenerateColumns="False" BackColor="White"
                                                ...
                                                OnRowEditing="GrdOrder_RowEditing" ShowFooter="True" ShowHeader="False" Width="100%"
                                                Font-Size="X-Small">
                                            ...
                                            <div style="left: 10px; width: 333px; position: absolute; top: 280px; height: 315px">
                                                <asp:Panel ID="Panel3" runat="server" BackColor="Silver" BorderColor="White" BorderStyle="Inset"
                                                    BorderWidth="1px" CssClass="HidePanel" Height="320px" Width="330px">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right" style="border-bottom: black thin solid" valign="top">
                                                                    <asp:Button ID="Button5" runat="server" BorderStyle="Groove" BorderWidth="1px" Font-Size="8pt"
                                                                        Height="16px" Text="X" Width="21px" />
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    <asp:ListBox ID="LstAccountHead" runat="server" CssClass="DropList" Height="295px"
                                                        onkeydown="SelectCode(event)" Width="325px"></asp:ListBox>
                                                </asp:Panel>
                                                &nbsp; &nbsp;&nbsp;
                                            </div>
                                            &nbsp;&nbsp;
