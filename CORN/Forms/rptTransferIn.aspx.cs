    ...
    protected void btnViewPDF_Click(object sender, EventArgs e)
    {
        try
        {
            if (DrpReportType.SelectedIndex == 2)
            {
                ...
                DataSet ds = RptInventoryCtl.TransferInOutValue(Constants.IntNullValue, int.Parse(DrpLocation.SelectedValue.ToString()), Convert.ToDateTime(FromDate + " 00:00:00"), Convert.ToDateTime(ToDate + " 00:00:00"), this.RbTransferType.SelectedItem.Text, int.Parse(this.Session["UserId"].ToString()));
            ...
            else
            {
                ...
                DataSet ds = RptInventoryCtl.TransferIn(Constants.IntNullValue, int.Parse(DrpLocation.SelectedValue.ToString()), Convert.ToDateTime(FromDate + " 00:00:00"), Convert.ToDateTime(ToDate + " 00:00:00"), this.RbTransferType.SelectedItem.Text, DrpReportType.SelectedIndex);
                DataTable dt = DPrint.SelectReportTitle(int.Parse(DrpLocation.SelectedValue.ToString()));
