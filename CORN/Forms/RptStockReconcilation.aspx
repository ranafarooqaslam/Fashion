                                ...
                                <table>
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        <td align="left">
                                            <%--<strong>
                                                <asp:Label ID="Label1" runat="server" Height="13px" Text="" Width="80px"></asp:Label></strong>--%>
                                        </td>
                                        <td align="left">
                                        </td>
                                        <td align="left" style="height: 25px">
                                            &nbsp;<asp:CheckBox runat="server" ID="chbZeroElimination" Checked="false"  Text="Zero Elimination"/>
                                        </td>
                                    </tr>
