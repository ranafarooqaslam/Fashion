<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="rptItemLedger.aspx.cs" Inherits="Forms_rptItemLedger"
    Title="CORN :: Item Wise Profit/Loss Report" %>
        ...
        <table width="100%">
            <tr>
                <td>
                            ...
                            <asp:Panel ID="pnl_rpt" runat="server">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <strong>
                                                <asp:Label ID="Label6" runat="server" CssClass="lblbox" Text="Item" Width="78px"></asp:Label></strong>
                                        </td>
                                        <td align="left"></td>
                                        <td align="left" style="height: 25px">
                                            <asp:DropDownList ID="ddlSKU" runat="server" Width="200px" CssClass="DropList">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    &nbsp; &nbsp;
                    <asp:Button Style="margin: 10px;" ID="btnViewPDF" runat="server" CssClass="Button" Width="90" Text="View PDF"
