<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="frmBusinessType.aspx.cs" Inherits="Forms_frmBusinessType" Title="CORN :: Customer Type" %>
                                        ...
                                        <td align="center" colspan="3">
                                            <asp:Panel ID="Panel1" runat="server" Height="200px" ScrollBars="Vertical" Width="100%">
                                                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                    <ContentTemplate>
                                                        <asp:GridView ID="grdChannelData" runat="server" Width="90%" ForeColor="SteelBlue"
                                        ...
                                        <td align="center" colspan="3">
                                            <asp:Panel ID="Panel2" runat="server" Height="200px" ScrollBars="Vertical" Width="100%">
                                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                    <ContentTemplate>
                                                        <asp:GridView ID="GrdBusType" runat="server" Width="90%" ForeColor="SteelBlue" CssClass="gridRow2"
                        ...
                        <cc1:TabPanel ID="TabPanel3" runat="server">
                            ...
                            <ContentTemplate>
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td align="center" colspan="3">
                                            <asp:Panel ID="Panel3" runat="server" Height="180px" ScrollBars="Vertical" Width="100%">
                                                <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                                    <ContentTemplate>
                                                        <asp:GridView ID="GrdVolumeClass" runat="server" Width="99%" ForeColor="SteelBlue"
                                                            CssClass="gridRow2" BorderColor="White" BackColor="White" HorizontalAlign="Center"
                                                            AutoGenerateColumns="False" OnRowEditing="GrdVolumeClass_RowEditing" OnRowDeleting="GrdVolumeClass_RowDeleting"
