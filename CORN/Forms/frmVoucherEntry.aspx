                    ...
                    <td>
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="height: 20px" align="left">
                                                <asp:DropDownList ID="drpDistributor" runat="server" Width="206px" CssClass="DropList">
                                                </asp:DropDownList>
                                            </td>
                                            <td align="left">
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="height: 20px" align="left">
                                                <asp:TextBox ID="txtSlipNo"  runat="server" Width="200px" CssClass="txtBox "></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="height: 25px" align="left">
                                            ...
                                            <td style="height: 20px" align="left">
                                                <asp:TextBox ID="txtChequeDate"  runat="server" Width="200px" 
                                                    CssClass="txtBox "></asp:TextBox>
                                            <%-- <asp:ImageButton ID="ibtnChequeDate" runat="server"  Width="16px" ImageUrl="~/App_Themes/Granite/Images/date.gif">
                                            </asp:ImageButton>--%>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="height: 25px" align="left">
                                                <asp:TextBox ID="txtDueDate"   runat="server" Width="200px"
                                                    CssClass="txtBox " ></asp:TextBox>
                                             <%-- <asp:ImageButton ID="ibtnDueDate" runat="server"  Width="16px" ImageUrl="~/App_Themes/Granite/Images/date.gif">
                                            </asp:ImageButton>--%>
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <cc1:CalendarExtender ID="CalendarExtender1" runat="server" PopupButtonID="txtChequeDate" 
                                    TargetControlID="txtChequeDate" Format="dd-MMM-yyyy">
                                </cc1:CalendarExtender>
                                  <cc1:CalendarExtender ID="CalendarExtender2" runat="server" PopupButtonID="txtVoucherDate" 
                                    TargetControlID="txtVoucherDate" Format="dd-MMM-yyyy">
                                </cc1:CalendarExtender>
                              <%--  <cc1:MaskedEditExtender ID="MaskedEditExtender2" runat="server" Mask="99/99/9999"
                                    MaskType="Date" TargetControlID="txtVoucherDate">
                                </cc1:MaskedEditExtender>--%>
                                <cc1:CalendarExtender ID="CalendarExtender3"  runat="server" PopupButtonID="txtDueDate" Format="dd-MMM-yyyy"
                    ...
                    <td>
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
                                        ...
                                        <tr>
                                            <td style="height: 12px" colspan="2">
                                                <%--<asp:TextBox ID="txtAccountCode" onkeyup="SearchList()" runat="server" Width="76px"
                                                    CssClass="txtBox "></asp:TextBox>--%>
                                                <asp:DropDownList ID="drpAccountCodeName" runat="server" Width="247px" CssClass="DropList">
                                                </asp:DropDownList>
                                            </td>
                                          <%--  <td colspan="1" rowspan="1">
                                            ...
                                            <td style="height: 12px">
                                                <asp:TextBox ID="txtAccountDes"  runat="server" Width="140px"
                                                    CssClass="txtBox "></asp:TextBox>
                                            </td>
                                            <td style="height: 12px">
                                        ...
                                        <tr>
                                            <td align="center" colspan="8" rowspan="1">
                                                <asp:GridView ID="GrdOrder" runat="server" Width="100%" ForeColor="SteelBlue" CssClass="gridRow2"
                                                    ...
                                                    OnRowEditing="GrdOrder_RowEditing" ShowFooter="True" ShowHeader="False">
                                                ...
                                                <div style="left: 100px; width: 325px; position: absolute; top: 350px; height: 200px">
                                                    <asp:Panel ID="Panel3" runat="server" Width="325px" Height="200px" CssClass="HidePanel"
                                                       ...
                                                       <%-- <asp:ListBox ID="LstAccountHead" onkeydown="SelectCode(event)" runat="server" Width="325px"
                                                            Height="200px" CssClass="DropList"></asp:ListBox>--%>
                                                    </asp:Panel>
                                                    &nbsp; &nbsp;&nbsp;
                                                </div>
                                                &nbsp;&nbsp;
                                ...
                                <div style="z-index: 101; left: 706px; width: 100px; position: absolute; top: 364px;
                                    height: 100px">
