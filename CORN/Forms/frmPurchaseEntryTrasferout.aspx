<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="frmPurchaseEntryTrasferout.aspx.cs" Inherits="Forms_frmPurchaseEntryTrasferout" Title="CORN :: Transfer Out" %>
                            ...
                            <ContentTemplate>
                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <asp:TextBox ID="txtskuCode" runat="server" Width="340px" placeholder="Please enter Code here"   onkeypress="Calculate(event);"></asp:TextBox>
