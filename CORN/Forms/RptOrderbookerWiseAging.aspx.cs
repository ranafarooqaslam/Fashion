...
public partial class Forms_RptOrderbookerWiseAging : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            txtDocmentDate.Text = CORNCommon.Classes.Configuration.SystemCurrentDateTime.ToString("dd-MMM-yyyy");
        }
    }
    ...
    protected void btnViewPDF_Click(object sender, EventArgs e)
    {
        ...
        CORNBusinessLayer.Reports.CrpCreditAgingOrderBookerWise CrpReport = new CORNBusinessLayer.Reports.CrpCreditAgingOrderBookerWise();
