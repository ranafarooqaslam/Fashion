    ...
    protected void btnViewPDF_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (RbReportType.SelectedIndex == 0)
            {
                ...
                CORNBusinessLayer.Reports.CrpLoadPass CrpReport = new CORNBusinessLayer.Reports.CrpLoadPass();
            ...
            else
            {
                ...
                CORNBusinessLayer.Reports.CrpOrderBookerSheet CrpReport = new CORNBusinessLayer.Reports.CrpOrderBookerSheet();
                CrpReport.SetDataSource(ds);
                CrpReport.Refresh();
