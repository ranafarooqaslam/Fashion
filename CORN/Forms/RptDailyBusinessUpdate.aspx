<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="RptDailyBusinessUpdate.aspx.cs" Inherits="Forms_RptDailyBusinessUpdate"
    Title="CORN :: Daily Business Update Report" %>
        ...
        <table width="100%">
            <tr>
                <td>
                    ...
                    <asp:Button ID="btnPDF" runat="server" Text="View PDF" OnClick="btnPDF_Click" CssClass="Button"
                        Width="90" />
                    <asp:Button ID="btnExcel" runat="server" Text="View Excel" OnClick="btnExcel_Click"
