...
public partial class Forms_RptSalesTaxReturn : System.Web.UI.Page
{
    ...
    private void ShowReport(int p_ReportType)
    {
        ...
        if (rbDetail.Checked)
        {
            CrpReport = new CORNBusinessLayer.Reports.CrpSaletaxDetail();
        }
        else if (rbSummary.Checked)
        {
            CrpReport = new CORNBusinessLayer.Reports.CrpSaletaxSummary();
        }
        else
        {
            CrpReport = new CORNBusinessLayer.Reports.CrpSaletaxCustomerWise();
        }
