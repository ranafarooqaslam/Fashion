<%@ Page Title="CORN :: Short/Excess Document" Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true" CodeFile="RptShortExcessDocument.aspx.cs" Inherits="Forms_RptShortExcessDocument" %>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:RadioButtonList ID="RdbTransferType" runat="server" Width="200px" RepeatDirection="Horizontal">
                                            <asp:ListItem Selected="True" Text="Short" Value="8"></asp:ListItem>
                                            <asp:ListItem Text="Excess" Value="9"></asp:ListItem>
                                        </asp:RadioButtonList>
                                    </td>
                                </tr>
                                <tr>
