...
public partial class Forms_frmDailyBalances : System.Web.UI.Page
{
    ...
    protected void btnViewPDF_Click(object sender, EventArgs e)
    {
        ...
        if (rblType.SelectedIndex == 0)
        {
            ...
            CORNBusinessLayer.Reports.CrpDailyBalnace CrpReport = new CORNBusinessLayer.Reports.CrpDailyBalnace();
        ...
        else if (rblType.SelectedIndex == 1)
        {
            ...
            CORNBusinessLayer.Reports.CrpUtilizationFound CrpReport = new CORNBusinessLayer.Reports.CrpUtilizationFound();
            CrpReport.SetDataSource(ds);
            CrpReport.Refresh();
        ...
        else
        {
            ...
            CORNBusinessLayer.Reports.CrpDailyBalanceSummary CrpReport = new CORNBusinessLayer.Reports.CrpDailyBalanceSummary();
            CrpReport.SetDataSource(ds);
            CrpReport.Refresh();
