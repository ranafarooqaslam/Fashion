...
public partial class Forms_RptCustomerClassficationReport : System.Web.UI.Page
{
    ...
    private void LoadSKUS()
    {
        if (ddskuBrand.Items.Count > 0)
        {
            ...
            if (ddskuBrand.SelectedValue.ToString() != Constants.IntNullValue.ToString())
            {
                ...
                DataTable m_dt = mSKUController.SelectSkuInfo(compid, divid, catid,Constants.IntNullValue, barandid, varid);
    ...
    protected void btnViewPDF_Click(object sender, EventArgs e)
    {
        ...
        if (RBReportType.SelectedIndex == 0)
        {
            ...
            CORNBusinessLayer.Reports.CrpCustomerClassfication CrpReport = new CORNBusinessLayer.Reports.CrpCustomerClassfication();
        ...
        else
        {
            ...
            CORNBusinessLayer.Reports.CrpCustomerClassificationDetail CrpReport = new CORNBusinessLayer.Reports.CrpCustomerClassificationDetail();
            CrpReport.SetDataSource(ds);
            CrpReport.Refresh();
