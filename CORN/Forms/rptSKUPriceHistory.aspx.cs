...
public partial class Forms_rptSKUPriceHistory : System.Web.UI.Page
{
    ...
    private void ShowReport(int p_Report_Type)
    {
        ...
        if (int.Parse(DrpPrices.SelectedValue) == 0)
        {
            ...
            CORNBusinessLayer.Reports.CrpSKUPriceHistory CrpReport = new CORNBusinessLayer.Reports.CrpSKUPriceHistory();
        ...
        {
            CORNBusinessLayer.Reports.CrpSKUPriceHistory2 CrpReport = new CORNBusinessLayer.Reports.CrpSKUPriceHistory2();
    ...
    private void LoadSKUDetail()
    {
        if (DrpCategory.Items.Count > 0)
        {
            ...
            DataTable dt = mContoller.SelectSkuInfo(int.Parse(DrpPrincipal.SelectedValue), Constants.IntNullValue, int.Parse(DrpCategory.SelectedValue),Constants.IntNullValue, Constants.IntNullValue, Constants.IntNullValue);              
    ...
    private void LoadCategory()
    {
        ...
        DataTable dtCatagory = Hierarchy.SelectSkuHierarchyView(7, int.Parse(this.Session["CompanyId"].ToString()));
        this.DrpCategory.Items.Add(new ListItem("All", Constants.IntNullValue.ToString()));
        clsWebFormUtil.FillDropDownList(this.DrpCategory, dtCatagory, "SKU_HIE_ID", "SKU_HIE_NAME");
        this.LoadSKUDetail();
    }
