...
public partial class Forms_RptUnProductiveCustomerList : System.Web.UI.Page
{
    ...
    protected void btnViewPDF_Click(object sender, EventArgs e)
    {
        ...
        CORNBusinessLayer.Reports.CrpUnProductiveCustomerList CrpReport = new CORNBusinessLayer.Reports.CrpUnProductiveCustomerList();
        DataSet ds = null;
    ...
    protected void btnViewExcel_Click(object sender, EventArgs e)
    {
        ...
        string path = CORNCommon.Classes.Configuration.GetAppInstallationPath() + "\\UnProductiveCustomerList.xls";
