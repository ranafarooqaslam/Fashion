...
public partial class Forms_RptPrincipalWiseExp : System.Web.UI.Page
{
    ...
    protected void btnViewExcell_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ds = RptAccountCtl.PrincipalWiseSaleesc(int.Parse(drpPrincipal.SelectedValue.ToString()), Convert.ToInt32(this.DrpLocation.SelectedValue.ToString()), Convert.ToDateTime(FromDate + " 00:00:00"), Convert.ToDateTime(ToDate + " 23:59:59"), Catagories_IDs, Constants.IntNullValue);
