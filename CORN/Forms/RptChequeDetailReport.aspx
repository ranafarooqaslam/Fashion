<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    ...
    Title="CORN :: Cheque Detail Report" %>
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 258px; height: 25px" align="left">
                                            &nbsp;
                                            <asp:DropDownList ID="DrpPrincipal" runat="server" Width="240px" __designer:wfdid="w2"
                                                CssClass="DropList">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                                ...
                                                <table>
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <strong>
                                                                    <asp:Label ID="Label10" runat="server" Width="80px" Text="Status" CssClass="lblbox"></asp:Label></strong>
                                                            </td>
                                                            <td align="left">
                                                            </td>
                                                            <td style="height: 25px" align="left">
