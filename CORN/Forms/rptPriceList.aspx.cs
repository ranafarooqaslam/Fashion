...
public partial class Forms_rptPriceList : System.Web.UI.Page
{
    ...
    protected void LoadCatagory()
    {
        ...
        clsWebFormUtil.FillDropDownList(this.DrpCatagory, dtCatagory, "SKU_HIE_ID", "SKU_HIE_NAME");
    }
    ...
    protected void btnViewPDF_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            CORNBusinessLayer.Reports.CrpPriceList CrpReport = new CORNBusinessLayer.Reports.CrpPriceList();
            DataSet ds = null;
    ...
    protected void btnViewExcel_Click(object sender, EventArgs e)
    {
           ...
           string path = CORNCommon.Classes.Configuration.GetAppInstallationPath() + "\\PriceList.xls";
