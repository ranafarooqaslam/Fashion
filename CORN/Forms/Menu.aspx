<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="Menu.aspx.cs" Inherits="Forms_Menu" %>
    ...
    <div id="right_data">
        <table>
            <tr>
                <td colspan="2">
                    <h2>
                        <asp:Label ID="lblTitle" runat="server" Text="Add Level"></asp:Label></h2>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                <td width="20%">
                    <strong>
                        <asp:Label ID="lblMenu" runat="server" Text="Name:"></asp:Label>
                    </strong>
                </td>
                <td width="80%">
                    <asp:TextBox ID="txtMenu" runat="server" Width="180px"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rfvMenu" runat="server" ControlToValidate="txtMenu"
                        ErrorMessage="Plz enter Level Name" ValidationGroup="vgMenu"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td colspan="2" align="center">
                    ...
                    <asp:Button ID="btnAdd" runat="server" Text="Save" OnClick="btnAdd_Click" CssClass="Button"
                        Width="80" ValidationGroup="vgMenu" />
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                <td colspan="2">
                    <h2>
                        <asp:Label ID="lblFormTitle" runat="server" Visible="false" Text="Add Forms To Level"></asp:Label>
                    </h2>
                </td>
            </tr>
        </table>
        <div>
            <asp:GridView ID="gvMain" runat="server" AutoGenerateColumns="False" Width="100%"
                DataKeyNames="MODULE_ID" CellPadding="0" CellSpacing="0" ForeColor="Black" GridLines="None"
                                ...
                                <tr>
                                    ...
                                    <td align="left" width="15">
                                        <div id='imgplus<%# Eval("MODULE_ID") %>'>
                                            <a href="javascript:void();" onclick="ShowHide('<%# Eval("MODULE_ID")%>','1')">
                                                <img src="../images/left_navi-icon1_off.png" width="11" height="11" /></a>
                                        </div>
                                        <div id='imgminus<%# Eval("MODULE_ID") %>' style="display: none;">
                                            <a href="javascript:void();" onclick="ShowHide('<%# Eval("MODULE_ID")%>','1')">
                                                <img src="../images/left_navi-icon1_on.png" width="11" height="11" /></a>
                                        </div>
                                    </td>
                                    <td align="left">
                                        <h1>
                                            <%# Eval("MODULE_DESCRIPTION")%></h1>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3">
                                        <div id='dvtr<%# Eval("MODULE_ID") %>' style="display: none;">
                                            <asp:GridView ID="gvSubMenu" runat="server" Width="100%" AutoGenerateColumns="False"
                                                DataKeyNames="MODULE_ID" CellPadding="0" CellSpacing="0" ForeColor="Black" GridLines="None"
                                                ShowHeader="false" OnRowDataBound="gvSubMenu_RowDataBound">
                                                <Columns>
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                                                <tr>
                                                                    ...
                                                                    <td align="left" width="15">
                                                                        <div id='imgplus<%# Eval("MODULE_ID") %>'>
                                                                            <a href="javascript:void();" onclick="ShowHide('<%# Eval("MODULE_ID")%>','2')">
                                                                                <img src="../images/left_navi-icon1_off.png" width="11" height="11" /></a>
                                                                        </div>
                                                                        <div id='imgminus<%# Eval("MODULE_ID") %>' style="display: none;">
                                                                            <a href="javascript:void();" onclick="ShowHide('<%# Eval("MODULE_ID")%>','2')">
                                                                    ...
                                                                    <td colspan="3">
                                                                        <div id='dvttr<%# Eval("MODULE_ID") %>' style="display: none;">
                                                                            <asp:GridView ID="gvForms" runat="server" Width="100%" AutoGenerateColumns="False"
                                                                                CellPadding="0" CellSpacing="0" ForeColor="Black" GridLines="None" ShowHeader="false"
                                                                                            ...
                                                                                            <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td align="left" width="5%">
                                                                                                        <asp:CheckBox ID="cbModule" runat="server" />
                                                                                                    </td>
                                                                                                    <td align="left" width="500">
                                                                                                        <h2>
                                                                                                            <%# Eval("MODULE_DESCRIPTION")%></h2>
                                                                                                    </td>
                                                                                                    <td align="left">
