...
/// </summary>
public partial class Forms_RptDailyTopSeller : System.Web.UI.Page
{
    /// <summary>
    /// Page_Load Function
    /// </summary>
   ...
   //     DrpPrincipal.Items.Add(new ListItem("All", Constants.IntNullValue.ToString()));
    ...
    protected void btnViewPDF_Click(object sender, EventArgs e)
    {
        ...
        if (txtUpto.Text == "" || txtUpto.Text == null)
        {
            upto = 0;
        }
        else
        {
            upto = int.Parse(txtUpto.Text);
        }
        DataControl dc = new DataControl();
        ds = RptInventoryCtl.SelectDailyTopSellerReport(int.Parse(drpDistributor.SelectedValue.ToString()), int.Parse(DrpPrincipal.SelectedValue.ToString()),
            DateTime.Parse(txtStartDate.Text + " 00:00:00"), DateTime.Parse(txtEndDate.Text + " 23:59:59"),int .Parse (rblType .SelectedIndex .ToString ()),upto );


        ReportDocument CrpReport = new ReportDocument();
        CrpReport = new CORNBusinessLayer.Reports.CrpDailyTopSellerReport();
      ...
      //  CrpReport.SetParameterValue("ReportTitle", "Date Wise " + DrpDocumentType.SelectedItem.Text + " Report");
        ...
        CrpReport.SetParameterValue("Type","Report Type "+ rblType.SelectedItem.Text);
