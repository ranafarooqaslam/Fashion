...
public partial class Forms_frmCustomerShifting : System.Web.UI.Page
{
    ...
    private void LoadCustomer()
    {
        if (drpfromDistributor.Items.Count > 0 && DrpfromRoute.Items.Count > 0 && DrpFromMarket.Items.Count > 0)
        {
            ...
            DataTable dt = CustomerDataController.SelectPrincipalCustomer(int.Parse(drpfromDistributor.SelectedValue.ToString()), int.Parse(DrpfromRoute.SelectedValue.ToString()), Convert.ToInt32(DrpFromMarket.SelectedValue), Constants.IntNullValue);
