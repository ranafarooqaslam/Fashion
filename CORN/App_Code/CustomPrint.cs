...
/// <summary>
/// Summary description for CustomPrint
/// </summary>
        ...
        if (PlatformID.Win32NT == Environment.OSVersion.Platform)
        {
            ...
            if (OpenPrinter(printerName, out hPrinter, ref defaults))
            {
                try
                {
                    ...
                    int iDevModeSize = DocumentProperties(IntPtr.Zero, hPrinter, printerName, IntPtr.Zero, IntPtr.Zero,
                        0);
                    ...
                    if (!bSuccess)
                        throw new Win32Exception(Marshal.GetLastWin32Error(),
                            "SetPrinter() failed.  Couldn't set the printer settings");
                    ...
                    SendMessageTimeout(
                        ...
                        IntPtr.Zero,
                        IntPtr.Zero,
                        CustomPrint.SendMessageTimeoutFlags.SMTO_NORMAL,
                        1000,
                        out hDummy);
                }
                finally
